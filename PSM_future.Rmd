...
```{r landgis-soil, echo=FALSE, fig.cap="General workflow of the spatial prediction system used to produce soil property and class maps via the LandGIS.", out.width="85%"}
...
```{r psm-design-users, echo=FALSE, fig.cap="Recommended decision tree for design of PSM. In essence, users' perspective and technical settings should be the key for most of decisions when it comes to design of PSM projects.", out.width="95%"}
...
```{r mobile-phone-scheme, echo=FALSE, fig.cap="Future Global Land Information System (built on the top of the LandGIS concept) and targeted functionality: users on ground send local O and M through their mobile phones, which are then used to run and re-callibrate global models.", out.width="100%"}
