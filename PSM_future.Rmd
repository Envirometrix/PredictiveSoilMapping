...
```{r mobile-phone-scheme, echo=FALSE, fig.cap="Future Global Land Information System (built on the top of the LandGIS concept) and targeted functionality: users on ground send local O&M through their mobile phones, which are then used to run and re-callibrate global models.", out.width="100%"}
