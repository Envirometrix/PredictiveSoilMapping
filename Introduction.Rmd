...
to put it to new and beneficial use,s so that its value is increased and
not just preserved.
...
```{r from-photointerpretation-to-soilmap, echo=FALSE, fig.cap="In conventional soil mapping, soil delineations are usually manually drawn polygons representing (assumed) bodies of homogenous soil materials (often geomorphological units). These are first validated in the field before a final area-class map is produced, which can then be generalized and used to extract soil property maps. After @SSS1983USDA.", out.width="95%"}
