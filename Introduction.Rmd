...
```{r soil-crop-model-scheme, echo=FALSE, fig.cap="Inputs to soil-plant, soil-hydrology or soil-ecology models and their relationship.", out.width="100%", out.extra="angle=270"}
...
```{r site-horizon-structure, echo=FALSE, fig.cap="An example of a basic soil profile geographical database, which commonly consists of four tables: SITE, HORIZON, DESCRIPTION and NAMES tables (a). To facilitate rapid display and use of soil variables, SITE and HORIZON tables can be combined into a single (*wide*) table structure (b).", out.width="80%", out.extra="angle=270"}
...
```{r automap-future, echo=FALSE, fig.cap="The future of global mapping and environmental monitoring activities is expected to be increasingly automated and distributed.", out.width="75%", out.extra="angle=270"}
...
```{r usability-scheme, echo=FALSE, fig.cap="Usability of a Soil Information System is basically a function of a number of data usability measures from which the following four (C’s) are essential: completeness, consistency, correctness and currency.", out.width="75%", out.extra="angle=270"}
...
```{r lagacherie1992, echo=FALSE, fig.cap="Reduction of prediction error as a function of sampling intensity (for three control areas). Based on @Lagacherie1992PhD.", out.width="85%", out.extra="angle=270"}
