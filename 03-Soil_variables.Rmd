...
```{r usda-categories, echo=FALSE, fig.cap="USDA classification system and approximate minimum number of observations required to fit a global multinomial regression model.", out.width="60%", out.extra="angle=0"}
