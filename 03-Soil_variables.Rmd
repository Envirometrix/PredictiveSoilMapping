...
```{r plot-tt-triangle,fig.height=8, fig.width=8, fig.cap="Soil texture triangle based on the USDA system. Generated using the soiltexture package (http://cran.r-project.org/web/packages/soiltexture/)."}
library(soiltexture)
...
```{r plot-tt-afsis, fig.height=8, fig.width=8, fig.cap="Distribution of observed soil textures for the Africa Soil Profiles (http://gsif.r-forge.r-project.org/afsp.html)."}
