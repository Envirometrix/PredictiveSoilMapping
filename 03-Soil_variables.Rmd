...
```{r sprofs-bld, echo=FALSE, fig.cap="Histogram and soil-depth density distribution for a global compilation of measurements of bulk density (tonnes per cubic metre). Based on the records from WOSIS (http://www.earth-syst-sci-data.net/9/1/2017/).", out.width="90%"}
...
```{r available-soil-water, echo=FALSE, fig.cap="Example of a soil water content plot. Actual water content can be measured using soil moisture probes i.e. automated sensor networks.", out.width="100%"}
