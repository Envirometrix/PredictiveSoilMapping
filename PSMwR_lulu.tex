...
\CommentTok{#> R 2019-02-07 23:35:59 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> Warning in predLoess(object$y, object$x, newx = if}
\CommentTok{#> (is.null(newdata)) object$x else if (is.data.frame(newdata))}
\CommentTok{#> as.matrix(model.frame(delete.response(terms(object)), : pseudoinverse used}
\CommentTok{#> at 1.9652 0.3327 0}
\CommentTok{#> Warning in predLoess(object$y, object$x, newx = if}
\CommentTok{#> (is.null(newdata)) object$x else if (is.data.frame(newdata))}
\CommentTok{#> as.matrix(model.frame(delete.response(terms(object)), : neighborhood radius}
\CommentTok{#> 3.6664}
\CommentTok{#> Warning in predLoess(object$y, object$x, newx = if}
\CommentTok{#> (is.null(newdata)) object$x else if (is.data.frame(newdata))}
\CommentTok{#> as.matrix(model.frame(delete.response(terms(object)), : reciprocal}
\CommentTok{#> condition number 2.8503e-17}
\CommentTok{#> [1] "estimated time for  copula 160.814144604564"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x13987698> }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1549582619404_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.014970 0.009508}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.135921 0.176555}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001327 0.000831}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.002131   0.103575  0.365750 0.058548}
\CommentTok{#> 3 0.000000   -0.018129   0.071712  0.955210 0.022111}
\CommentTok{#> 4 0.000000   -0.001490   0.049557  0.106649 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> MAE:  13.7}
\CommentTok{#> RMSLE:  0.543}
\CommentTok{#> Mean Residual Deviance :  307}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.42 10.67 8.32 5.72 3.5 ...}
...
\CommentTok{#>   ..$ ME          : num -0.111}
\CommentTok{#>   ..$ MAE         : num 2.11}
\CommentTok{#>   ..$ RMSE        : num 3.6}
\CommentTok{#>   ..$ R.squared   : num 0.575}
\CommentTok{#>   ..$ logRMSE     : num 0.478}
\CommentTok{#>   ..$ logR.squared: num 0.658}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 9.08}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.94124988412339}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1587}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0827}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0775023328100552}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.805}
\CommentTok{#> SL.ksvm_All    0.1296 0.000}
\CommentTok{#> SL.glmnet_All  0.3076 0.000}
\CommentTok{#> SL.ranger_All  0.0839 0.195}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> }
\CommentTok{#>                  Risk  Coef}
\CommentTok{#> SL.xgboost_All 0.0603 0.818}
\CommentTok{#> SL.ranger_All  0.0839 0.182}
...
\CommentTok{#> SL.ranger_All  0.167 0.466}
\CommentTok{#> SL.ksvm_All    0.164 0.534}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.68 4.77 4.9 4.85 4.79 ...}
