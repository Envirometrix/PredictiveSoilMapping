...
\CommentTok{#> R 2019-02-19 10:43:54 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 154.492046964854"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x1516dd00> }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1550573092458_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.016108 0.010779}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.124212 0.159717}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001263 0.000782}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.006680   0.104132  0.363266 0.062252}
\CommentTok{#> 3 0.000000   -0.018683   0.071135  0.952644 0.020054}
\CommentTok{#> 4 0.000000    0.003394   0.046640  0.127844 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> }
\CommentTok{#> MSE:  264}
\CommentTok{#> RMSE:  16.2}
\CommentTok{#> MAE:  12.2}
\CommentTok{#> RMSLE:  0.498}
\CommentTok{#> Mean Residual Deviance :  264}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.93 10.63 8.78 5.99 3.47 ...}
...
\CommentTok{#>   ..$ ME          : num -0.112}
\CommentTok{#>   ..$ MAE         : num 2.14}
\CommentTok{#>   ..$ RMSE        : num 3.63}
\CommentTok{#>   ..$ R.squared   : num 0.569}
\CommentTok{#>   ..$ logRMSE     : num 0.487}
\CommentTok{#>   ..$ logR.squared: num 0.647}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.50}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.34604853873784}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1799}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0838}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0786247398987812}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8183}
\CommentTok{#> SL.ksvm_All    0.1286 0.0147}
\CommentTok{#> SL.glmnet_All  0.3075 0.0000}
\CommentTok{#> SL.ranger_All  0.0855 0.1670}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> }
\CommentTok{#>                  Risk  Coef}
\CommentTok{#> SL.xgboost_All 0.0603 0.815}
\CommentTok{#> SL.ranger_All  0.0832 0.185}
\CommentTok{#> SL.ksvm_All    0.1303 0.000}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   Super Learner 0.16 0.014 0.096 0.25}
\CommentTok{#>     Discrete SL 0.17 0.014 0.116 0.24}
\CommentTok{#>  SL.xgboost_All 0.19 0.016 0.135 0.27}
\CommentTok{#>   SL.ranger_All 0.16 0.014 0.106 0.24}
\CommentTok{#>     SL.ksvm_All 0.18 0.014 0.108 0.30}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.166 0.479}
\CommentTok{#> SL.ksvm_All    0.164 0.521}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.67 4.75 4.89 4.86 4.8 ...}
...
\CommentTok{#> Growing trees.. Progress: 92%. Estimated remaining time: 2 seconds.}
\NormalTok{m.BLD_PTF}
\CommentTok{#> Ranger result}
\CommentTok{#> }
\CommentTok{#> Call:}
