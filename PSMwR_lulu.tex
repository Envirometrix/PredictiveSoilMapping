...
\CommentTok{#> R 2019-02-26 13:22:05 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 204.154145389795"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x1396cb00> }
...
\CommentTok{#> MAE:  10}
\CommentTok{#> RMSLE:  0.426}
\CommentTok{#> Mean Residual Deviance :  219}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1551187385825_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.017534 0.012123}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.141631 0.187027}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001594 0.003091}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.004401   0.098025  0.316144 0.090264}
\CommentTok{#> 3 0.000000   -0.019093   0.071467  0.949935 0.020761}
\CommentTok{#> 4 0.000000    0.006620   0.037634  0.089137 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Mean Residual Deviance :  277}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 13.9 10.81 7.85 5.5 3.5 ...}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.72617899578525}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1389}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0752}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0728552430111611}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8113}
\CommentTok{#> SL.ksvm_All    0.1282 0.0137}
\CommentTok{#> SL.glmnet_All  0.3076 0.0000}
\CommentTok{#> SL.ranger_All  0.0848 0.1750}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> }
\CommentTok{#>                  Risk  Coef}
\CommentTok{#> SL.xgboost_All 0.0603 0.812}
\CommentTok{#> SL.ranger_All  0.0830 0.188}
\CommentTok{#> SL.ksvm_All    0.1306 0.000}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>     Discrete SL 0.17 0.014 0.115 0.25}
\CommentTok{#>  SL.xgboost_All 0.19 0.016 0.135 0.27}
\CommentTok{#>   SL.ranger_All 0.17 0.015 0.104 0.25}
...
\CommentTok{#> SL.ranger_All  0.167 0.47}
\CommentTok{#> SL.ksvm_All    0.164 0.53}
