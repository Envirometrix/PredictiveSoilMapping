...
\tightlist
\item
  Hengl, T., MacMillan, R.A., (2019). \textbf{Predictive Soil Mapping with R}. OpenGeoHub foundation, Wageningen, the Netherlands, 420 pages, www.soilmapper.org, ISBN: 978-0-359-30635-0.
\end{itemize}
...
and then either measured \emph{in-situ} or \emph{a posteriori} in a laboratory. Soil variables can be roughly grouped into:
...
\emph{`target variable'} (target soil properties) and \emph{`paths'} (determination methods).
...
SINFER concept would be to create and maintain a \textbf{Global Soil Reference}
...
\CommentTok{#> R 2019-02-07 15:23:46 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> at 2.4565 0.00011968 0}
\CommentTok{#> Warning in predLoess(object$y, object$x, newx = if}
\CommentTok{#> (is.null(newdata)) object$x else if (is.data.frame(newdata))}
...
\CommentTok{#> condition number 8.94e-50}
\CommentTok{#> [1] "estimated time for  copula 170.115417403525"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x149060e8> }
...
{\centering \includegraphics[width=0.55\linewidth]{figures/Fig_voxel_scheme} 
...
\CommentTok{#>     /tmp/RtmpqQFkga/h2o_travis_started_from_r.out}
\CommentTok{#>     /tmp/RtmpqQFkga/h2o_travis_started_from_r.err}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> Starting H2O JVM and connecting: .. Connection successful!}
\CommentTok{#> }
\CommentTok{#> R is connected to the H2O cluster: }
\CommentTok{#>     H2O cluster uptime:         2 seconds 239 milliseconds }
...
{\centering \includegraphics[width=0.55\linewidth]{figures/Measured_vs_predicted_SAND_plot} 
...
{\centering \includegraphics[width=1\linewidth]{PSMwR_lulu_files/figure-latex/map-snd-1} 
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1549553085844_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.014797 0.009938}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.123283 0.190451}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001290 0.000916}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.008718   0.102995  0.359419 0.062287}
\CommentTok{#> 3 0.000000   -0.017918   0.071053  0.958002 0.017264}
\CommentTok{#> 4 0.000000    0.004041   0.052819  0.092003 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
{\centering \includegraphics[width=1\linewidth]{PSMwR_lulu_files/figure-latex/map-snd-dl-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{PSMwR_lulu_files/figure-latex/maps-soc-edgeroi-1} 
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.11 10.6 9.17 5.8 3.46 ...}
...
\CommentTok{#>   ..$ ME          : num -0.133}
\CommentTok{#>   ..$ MAE         : num 2.14}
\CommentTok{#>   ..$ RMSE        : num 3.63}
\CommentTok{#>   ..$ R.squared   : num 0.568}
\CommentTok{#>   ..$ logRMSE     : num 0.485}
...
{\centering \includegraphics[width=0.55\linewidth]{figures/Predicted_vs_observed_plot_for_SOC_edgeroi} 
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.69}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.62800903074525}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1479}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0849}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0793881946561881}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8172}
\CommentTok{#> SL.ksvm_All    0.1284 0.0156}
\CommentTok{#> SL.glmnet_All  0.3081 0.0000}
\CommentTok{#> SL.ranger_All  0.0850 0.1671}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.0840 0.177}
\CommentTok{#> SL.ksvm_All    0.1307 0.000}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>     Discrete SL 0.17 0.015 0.115 0.25}
...
\CommentTok{#> SL.ranger_All  0.167 0.467}
\CommentTok{#> SL.ksvm_All    0.164 0.533}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.69 4.76 4.89 4.86 4.79 ...}
...
{\centering \includegraphics[width=0.9\linewidth]{PSMwR_lulu_files/figure-latex/plot-edgeroi-ocd-1} 
...
{\centering \includegraphics[width=0.85\linewidth]{PSMwR_lulu_files/figure-latex/thist-usa48-1} 
...
\citet{BRUS2019464} provides a systematic overview of sampling techniques and how
to implement them in R (\url{https://github.com/DickBrus/TutorialSampling4DSM}).
