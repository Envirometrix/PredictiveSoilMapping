...
\CommentTok{#>  [9] stringi_1.2.4    rmarkdown_1.11   stringr_1.3.1    xfun_0.4        }
...
\CommentTok{#> R 2019-02-12 09:18:50 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 160.386082449166"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x13f29ef8> }
...
This chapter reviews some common Machine learning algorithms (MLA's) that have demonstrated potential for soil mapping projects i.e.~for generating spatial predictions \citep{brungard2015machine, heung2016overview, behrens2018multi}. In this tutorial we especially focus on using tree-based algorithms such as \href{https://en.wikipedia.org/wiki/Random_forest}{random forest}, \href{https://en.wikipedia.org/wiki/Gradient_boosting}{gradient boosting} and \href{https://cran.r-project.org/package=Cubist}{Cubist}. For a more in-depth overview of machine learning algorithms used in statistics refer to the CRAN Task View on \href{https://cran.r-project.org/web/views/MachineLearning.html}{Machine Learning \& Statistical Learning}. Some other examples of how MLA's can be used to fit Pedo-Transfer-Functions can be found in section \ref{mla-ptfs}.
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1549963188467_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.013711 0.007716}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.140425 0.192243}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001775 0.005358}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000   -0.002089   0.098847  0.342926 0.070118}
\CommentTok{#> 3 0.000000   -0.018215   0.070967  0.952870 0.020799}
\CommentTok{#> 4 0.000000   -0.000950   0.045996  0.107101 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> }
\CommentTok{#> MSE:  279}
\CommentTok{#> RMSE:  16.7}
\CommentTok{#> MAE:  12.8}
\CommentTok{#> RMSLE:  0.518}
\CommentTok{#> Mean Residual Deviance :  279}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.53 10.94 9.63 6.53 3.49 ...}
...
\CommentTok{#>   ..$ R.squared   : num 0.571}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.31}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.1579913451598}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1275}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0796}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.07577984134046}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.mean_All    0.7540 0.000}
\CommentTok{#> SL.xgboost_All 0.0598 0.814}
\CommentTok{#> SL.ksvm_All    0.1289 0.010}
\CommentTok{#> SL.glmnet_All  0.3077 0.000}
\CommentTok{#> SL.ranger_All  0.0848 0.176}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> }
\CommentTok{#>                  Risk  Coef}
\CommentTok{#> SL.xgboost_All 0.0603 0.804}
\CommentTok{#> SL.ranger_All  0.0824 0.196}
\CommentTok{#> SL.ksvm_All    0.1297 0.000}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   Super Learner 0.16 0.014 0.094 0.26}
\CommentTok{#>     Discrete SL 0.17 0.014 0.111 0.25}
\CommentTok{#>  SL.xgboost_All 0.19 0.016 0.135 0.27}
\CommentTok{#>   SL.ranger_All 0.16 0.014 0.104 0.25}
\CommentTok{#>     SL.ksvm_All 0.18 0.015 0.110 0.30}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.166 0.476}
\CommentTok{#> SL.ksvm_All    0.164 0.524}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.73 4.82 4.95 4.92 4.85 ...}
...
\CommentTok{#> Growing trees.. Progress: 91%. Estimated remaining time: 3 seconds.}
\NormalTok{m.BLD_PTF}
\CommentTok{#> Ranger result}
\CommentTok{#> }
\CommentTok{#> Call:}
...
distribution of environmental covariates \citep{stumpf2016incorporating}. Potential point sample
