...
Hard copies of this book can be ordered from \href{http://www.lulu.com/shop/tomislav-hengl-and-robert-a-macmillan/predictive-soil-mapping-with-r/paperback/product-23977071.html}{www.lulu.com}. By purchasing a hard copy of this book from Lulu you donate \$12 to the OpenGeoHub foundation.
...
\CommentTok{#> R 2019-02-09 16:26:04 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 159.402303736929"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x144cc2b8> }
...
\CommentTok{#>     /tmp/RtmpaY5seq/h2o_travis_started_from_r.out}
\CommentTok{#>     /tmp/RtmpaY5seq/h2o_travis_started_from_r.err}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> Starting H2O JVM and connecting: .. Connection successful!}
\CommentTok{#> }
\CommentTok{#> R is connected to the H2O cluster: }
\CommentTok{#>     H2O cluster uptime:         2 seconds 402 milliseconds }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1549729623319_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.015129 0.012159}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.170011 0.199572}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001671 0.001047}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.007937   0.096413  0.287040 0.102575}
\CommentTok{#> 3 0.000000   -0.020817   0.071251  0.937466 0.029253}
\CommentTok{#> 4 0.000000    0.001820   0.043290  0.082925 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> }
\CommentTok{#> MSE:  359}
\CommentTok{#> RMSE:  18.9}
\CommentTok{#> MAE:  15.3}
\CommentTok{#> RMSLE:  0.586}
\CommentTok{#> Mean Residual Deviance :  359}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 13.84 10.94 8.42 6.17 3.14 ...}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.45292766170529}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1372}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0836}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0792663497286861}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8169}
\CommentTok{#> SL.ksvm_All    0.1290 0.0141}
\CommentTok{#> SL.glmnet_All  0.3073 0.0000}
\CommentTok{#> SL.ranger_All  0.0850 0.1689}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> }
\CommentTok{#>                  Risk  Coef}
\CommentTok{#> SL.xgboost_All 0.0603 0.823}
\CommentTok{#> SL.ranger_All  0.0842 0.177}
...
\CommentTok{#> SL.ranger_All  0.166 0.475}
\CommentTok{#> SL.ksvm_All    0.164 0.525}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.67 4.75 4.89 4.85 4.79 ...}
...
\CommentTok{#> Growing trees.. Progress: 93%. Estimated remaining time: 2 seconds.}
\NormalTok{m.BLD_PTF}
\CommentTok{#> Ranger result}
\CommentTok{#> }
\CommentTok{#> Call:}
