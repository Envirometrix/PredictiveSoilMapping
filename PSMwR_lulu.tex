...
\CommentTok{#> R 2019-02-14 21:38:56 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 153.766156750726"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x156bf890> }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1550180395669_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.015489 0.009071}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.142471 0.180532}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001344 0.000918}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.004371   0.104535  0.381316 0.051516}
\CommentTok{#> 3 0.000000   -0.018644   0.071537  0.955875 0.017957}
\CommentTok{#> 4 0.000000   -0.001712   0.046801  0.155386 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> RMSE:  16}
\CommentTok{#> MAE:  11.9}
\CommentTok{#> RMSLE:  0.488}
\CommentTok{#> Mean Residual Deviance :  256}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.16 9.8 8.74 5.55 3.29 ...}
...
\CommentTok{#>   ..$ ME          : num -0.114}
\CommentTok{#>   ..$ MAE         : num 2.12}
\CommentTok{#>   ..$ RMSE        : num 3.6}
\CommentTok{#>   ..$ R.squared   : num 0.576}
\CommentTok{#>   ..$ logRMSE     : num 0.48}
\CommentTok{#>   ..$ logR.squared: num 0.655}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.54}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.4212927882173}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1483}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0810022665568305}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.mean_All    0.7540 0.00000}
\CommentTok{#> SL.xgboost_All 0.0598 0.80877}
\CommentTok{#> SL.ksvm_All    0.1293 0.00763}
\CommentTok{#> SL.glmnet_All  0.3079 0.00000}
\CommentTok{#> SL.ranger_All  0.0844 0.18361}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> }
\CommentTok{#>                  Risk  Coef}
\CommentTok{#> SL.xgboost_All 0.0603 0.816}
\CommentTok{#> SL.ranger_All  0.0834 0.184}
...
\CommentTok{#>   Super Learner 0.16 0.014 0.095 0.26}
...
\CommentTok{#> SL.ranger_All  0.167 0.452}
\CommentTok{#> SL.ksvm_All    0.162 0.548}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.68 4.76 4.89 4.84 4.77 ...}
