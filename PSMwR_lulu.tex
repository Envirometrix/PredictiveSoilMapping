...
\usepackage[paperwidth=18.90cm, paperheight=24.58cm, top=2.170cm, bottom=3.510cm, inner=2.1835cm, outer=2.1835cm,]{geometry}
\usepackage{color}
\usepackage{fancyvrb}
\newcommand{\VerbBar}{|}
...
\begin{itemize}
\item
  Grolemund, G., (2014) \href{https://rstudio-education.github.io/hopr/}{\textbf{Hands-On Programming with R}}. O'Reilly, ISBN: 9781449359010, 236 pages.
\item
  Gillespie, C., Lovelace, R., (2016) \href{https://csgillespie.github.io/efficientR/}{\textbf{Efficient R programming}}. O'Reilly, ISBN: 9781491950753, 222 pages.
\item
  Wilke, C.O., (2019) \href{https://serialmentor.com/dataviz/}{\textbf{Fundamentals of Data Visualization}}. O'Reilly, in press.
\end{itemize}
...
\caption{Available water capacity and actual water content can be measured using soil moisture probes.}\label{fig:available-soil-water}
\end{figure}
...
\CommentTok{#> R 2019-01-30 15:49:01 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 158.893367426622"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x15335aa8> }
...
{\centering \includegraphics[width=1\linewidth]{PSMwR_lulu_files/figure-latex/obs-pred-snd-1} 
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1548863399872_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.014580 0.009134}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.154769 0.192770}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001446 0.000925}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.000048   0.100691  0.342758 0.071949}
\CommentTok{#> 3 0.000000   -0.018436   0.070889  0.953101 0.019439}
\CommentTok{#> 4 0.000000   -0.002240   0.050444  0.090192 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> MAE:  12.8}
\CommentTok{#> RMSLE:  0.522}
\CommentTok{#> Mean Residual Deviance :  287}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.04 10.07 9.34 6.37 3.26 ...}
...
\CommentTok{#>   ..$ ME          : num -0.115}
\CommentTok{#>   ..$ MAE         : num 2.11}
\CommentTok{#>   ..$ RMSE        : num 3.6}
\CommentTok{#>   ..$ R.squared   : num 0.577}
...
{\centering \includegraphics[width=1\linewidth]{PSMwR_lulu_files/figure-latex/plot-measured-predicted-1} 
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.15}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.06474013231746}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1308}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0743}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0742217264810016}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8125}
\CommentTok{#> SL.ksvm_All    0.1284 0.0103}
\CommentTok{#> SL.glmnet_All  0.3080 0.0000}
\CommentTok{#> SL.ranger_All  0.0847 0.1772}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> }
\CommentTok{#>                  Risk  Coef}
\CommentTok{#> SL.xgboost_All 0.0603 0.801}
\CommentTok{#> SL.ranger_All  0.0820 0.199}
...
\CommentTok{#> SL.ranger_All  0.166 0.469}
\CommentTok{#> SL.ksvm_All    0.163 0.531}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.65 4.72 4.84 4.81 4.73 ...}
