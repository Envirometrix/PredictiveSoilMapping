...
This is the online version of the Open Access book: \href{https://envirometrix.github.io/PredictiveSoilMapping/}{\textbf{Predictive Soil Mapping with R}}. Pull requests and general comments are welcome. These materials are based on technical tutorials initially developed by the \href{http://isric.org/}{ISRIC's} Global Soil Information Facilities (GSIF) development team over the period 2014--2017.

\textbf{This book is continuously updated}. For news and updates please refer to the \href{https://github.com/envirometrix/PredictiveSoilMapping/issues}{github issues}.

Hard copies of this book can be ordered from \href{http://www.lulu.com/spotlight/t_hengl}{www.lulu.com}. By purchasing a hard copy of this book from Lulu you donate \$12 to the OpenGeoHub foundation.
...
\tightlist
\item
  Hengl, T., MacMillan, R.A., (2019). \textbf{Predictive Soil Mapping with R}. OpenGeoHub foundation, Wageningen, the Netherlands, 370 pages, www.soilmapper.org, ISBN: 978-0-359-30635-0.
\end{itemize}
...
\href{https://opengeohub.org/people/tom-hengl}{\textbf{Tom Hengl}} is a Senior Researcher
...
with R can also be found at \url{http://youtube.com/c/ISRICorg} and
...
(\url{https://landgis.opengeohub.org}) which is envisaged as \emph{``an OpenStreetMap-type system''}
...
\href{https://opengeohub.org/people/bob-macmillan}{\textbf{Bob MacMillan}} is a retired
...
(\url{http://africasoils.net}). Throughout his career, Bob has shared his
...
geoinformation science and a number of other sciences \citep{Scul01, McBratney2003Geoderma, Henderson2004Geoderma, Boettinger2010Springer, Zhu2015PSM}. \emph{Predictive Soil Mapping with R}
...
\begin{itemize}
\item
  Malone, B.P, Minasny, B., McBratney, A.B., (2016) \href{https://www.springer.com/gp/book/9783319443256}{\textbf{Using R for Digital Soil Mapping}}. Progress in Soil Science
  ISBN: 9783319443270, 262 pages.
\item
  Hengl, T., \& MacMillan, R. A. (2009). \href{https://doi.org/10.1016/S0166-2481(08)00019-6}{\textbf{Geomorphometry---a key to landscape mapping and modelling}}. Developments in Soil Science, 33, 433--460.
\item
  California Soil Resource Lab, (2017) \href{https://casoilresource.lawr.ucdavis.edu/software/}{\textbf{Open Source Software Tools for Soil Scientists}}, UC Davis.
\item
  McBratney, A.B., Minasny, B., Stockmann, U. (Eds) (2018) \href{https://www.springer.com/gp/book/9783319634371}{\textbf{Pedometrics}}. Progress in Soil Science
  ISBN: 9783319634395, 720 pages.
\item
  FAO, (2018) \href{https://github.com/FAO-GSP/SOC-Mapping-Cookbook}{\textbf{Soil Organic Carbon Mapping Cookbook}}. 2nd edt. ISBN: 9789251304402
\end{itemize}
...
\begin{itemize}
\item
  Bivand, R., Pebesma, E., Rubio, V., (2013) \href{http://www.asdar-book.org}{\textbf{Applied Spatial Data Analysis with R}}. Use R Series, Springer, Heidelberg, 2nd Ed. 400 pages.
\item
  Irizarry, R.A., (2018) \href{https://rafalab.github.io/dsbook/}{\textbf{Introduction to Data Science: Data Analysis and Prediction Algorithms with R}}. HarvardX Data Science Series.
\item
  Kabacoff, R.I., (2011) \href{http://www.manning.com/kabacoff/}{\textbf{R in Action: Data Analysis and Graphics with R}}. Manning publications, ISBN: 9781935182399, 472 pages.
\item
  Kuhn, M., Johnson, K. (2013) \href{http://appliedpredictivemodeling.com}{\textbf{Applied Predictive Modeling}}. Springer Science, ISBN: 9781461468493, 600 pages.
\item
  Molnar, C. (2019) \href{https://christophm.github.io/interpretable-ml-book/}{\textbf{Interpretable Machine Learning: A Guide for Making Black Box Models Explainable}}, Leanpub, 251 pages.
\item
  Lovelace, R., Nowosad, J., Muenchow, J., (2018) \href{https://geocompr.robinlovelace.net}{\textbf{Geocomputation with R}}. R Series, CRC Press, ISBN: 9781138304512, 338 pages.
\item
  Reimann, C., Filzmoser, P., Garrett, R., Dutter, R., (2008) \href{https://onlinelibrary.wiley.com/doi/book/10.1002/9780470987605}{\textbf{Statistical Data Analysis Explained Applied Environmental Statistics with R}}. Wiley, Chichester, 337 pages.
\item
  Wilke, C.O., (2019) \href{https://serialmentor.com/dataviz/}{\textbf{Fundamentals of Data Visualization}}. O'Reilly, in press.
\item
  Wikle, C.K., Zammit-Mangion, A., and Cressie, N. (2019). \href{https://spacetimewithr.org}{\textbf{Spatio-Temporal Statistics with R}}. Chapman \& Hall/CRC, Boca Raton, FL.
\end{itemize}
...
\tightlist
\item
  The data needs to be available for the majority of tutorials presented in a
...
In principle, all submitted chapters should follow closely also the \href{https://en.wikipedia.org/wiki/Wikipedia:Five_pillars}{five pillars of Wikipedia}, especially: Verifiability, Reproducibility, No original research, Neutral point of view, Good faith, No conflict of interest, and No personal attacks.

\hypertarget{reproducibility}{%
\section*{Reproducibility}\label{reproducibility}}
\addcontentsline{toc}{section}{Reproducibility}

To reproduce the book, you need a recent version of \href{https://cran.r-project.org}{R},
and \href{http://www.rstudio.com/products/RStudio/}{RStudio} and up-to-date packages,
which can be installed with the following command (which requires \href{https://github.com/hadley/devtools}{\textbf{devtools}}):
...
authors acknowledge support received from the \href{http://africasoils.net}{AfSIS project},
...
in the book by Travis Nauman, Amanda Ramcharan, David G. Rossiter and \href{http://julienmoeys.info}{Julian Moeys}.
...
This book has been inspired by \href{https://geocompr.robinlovelace.net}{the Geocomputation with R book},
...
We are especially grateful to \href{https://nowosad.github.io/}{Jakub Nowosad} for helping with preparing this publication for press and with setting up all code so that it passes automatic checks.
...
\textbf{Data availability and Code license}: All data used in this book is either available through R packages or is available via the github repository. If not mentioned otherwise, all code presented is available under the \href{https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html}{GNU General Public License v2.0}.

\textbf{Copyright}: © 2019 Authors.

This work is licensed under a Creative Commons Attribution-ShareAlike 4.0 International License. LandGIS and OpenGeoHub are registered trademarks of the OpenGeoHub Foundation (\url{https://opengeohub.org}).

\hypertarget{soil-introduction}{%
\chapter{Soil resource inventories and soil maps}\label{soil-introduction}}
...
arbitrarily set to 2 m (\url{http://soils.usda.gov/education/facts/soil.html}).
...
According to \citet{frossard2006function} there are six key functions of soil:
...
Knowledge about soil is often assembled and catalogued through \emph{soil
...
in representing the spatial distribution of \emph{soil variables} --- measurable
or descriptive attributes commonly collected through field sampling
and then either measured \emph{in-situ} or \emph{a posteriori} in a laboratory.
...
This attribute of conventional soil mapping (\emph{soil individuals}) represents a significant
...
simulations. Some known \textbf{sources of spatial variability} in soil variables
are:
...
{\centering \includegraphics[width=0.9\linewidth]{figures/Table_comparison_DSM} 

}

\caption{Matrix comparison between traditional (primarily expert-based) and automated (data-driven) soil mapping.}\label{fig:comparison-dsm}
\end{figure}
...
\citet{McBratney2003Geoderma} re-conceptualized and extended the CLORPT model via the
...
\item
  \textbf{c}limate,
\item
  \textbf{o}rganisms, vegetation, fauna or human activity,
\item
  \textbf{r}elief,
\item
...
\item
  \textbf{n} space, spatial context or spatial position,
\end{itemize}
...
\item
  \emph{Prepare final documentation describing all mapped soils and
...
so as to map actual \emph{polypedons} (complex of contiguous pedons).
...
on the application and user demands \citep{Wysocki2005Geoderma}.
...
landscape occupied by each named soil class \citep{MacMillan2005CJSS}. In other cases, soil
...
{\centering \includegraphics[width=0.85\linewidth]{figures/Fig_soilmap_types} 
...
research} (\url{http://en.wikipedia.org/wiki/Reproducibility}).
...
\BeginKnitrBlock{rmdnote}
Differences among \emph{conventional soil mapping} and \emph{digital soil mapping} (or
...
the first soil investigations 100 or more years ago \citep{arrouays2017soil}. More specifically,
...
\emph{soft data} (data based on qualitative information or quick observations).
...
\hypertarget{soil-databases-information}{%
\section{Soil databases and soil information systems}\label{soil-databases-information}}

\hypertarget{soil-databases}{%
\subsection{Soil databases}\label{soil-databases}}
...
{\centering \includegraphics[width=0.65\linewidth,angle=0]{figures/Fig_automap_future} 
...
\item
  \emph{Data integrity and interoperability} --- How can the data be integrated
...
\emph{``longevity''}, or persistence, of uncertain information can be evaluated, i.e.~to what
...
\citet{kuhn2013applied} list the four most common reasons why a predictive model fails:
...
{\centering \includegraphics[width=0.8\linewidth,angle=0]{figures/Fig_Lagacherie1992} 
...
\caption{Relationship between the numeric resolution (visualized using a histogram plot on the left), and amount of variation explained by the model and standard deviation of the prediction error. Variable used in this example: soil pH.}\label{fig:sigma-rmse-relationship}
\end{figure}
...
{\centering \includegraphics[width=0.55\linewidth]{figures/software_triangle} 
...
\item
  \href{https://trac.osgeo.org/gdal/wiki/DownloadingGdalBinaries}{GDAL v2.x} for Windows machines use e.g. \href{http://download.gisinternals.com/sdk/downloads/}{``gdal-*-1800-x64-core.msi``};
\end{itemize}

R script used in this tutorial can be downloaded from \textbf{\href{https://github.com/envirometrix/PredictiveSoilMapping}{github}}. As a gentle introduction to the R programming language and to soil classes in R we recommend the section \ref{variables-importing} on importing and using soil data. Some more examples of SAGA GIS + R usage can be found in the soil covariates chapter. To visualize spatial predictions in a web-browser or Google Earth you can try using plotKML package \citep{Hengl2014plotKML}. As a gentle introduction to the R programming language and spatial classes in R we recommend following \href{https://geocompr.robinlovelace.net/}{the Geocomputation with R book}. Obtaining the \href{https://cran.r-project.org/doc/contrib/Baggott-refcard-v2.pdf}{R reference card} is also highly recommended.
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{sudo}\NormalTok{ apt-get install libgdal-dev libproj-dev}
...
\CommentTok{#> R version 3.5.2 (2017-01-27)}
...
\CommentTok{#> [1] knitr_1.21           microbenchmark_1.4-6}
\CommentTok{#> }
\CommentTok{#> loaded via a namespace (and not attached):}
\CommentTok{#>  [1] compiler_3.5.2   magrittr_1.5     bookdown_0.9     tools_3.5.2     }
\CommentTok{#>  [5] htmltools_0.3.6  yaml_2.2.0       Rcpp_1.0.0       codetools_0.2-15}
\CommentTok{#>  [9] stringi_1.2.4    rmarkdown_1.11   stringr_1.3.1    xfun_0.5        }
\CommentTok{#> [13] digest_0.6.18    evaluate_0.12}
\end{Highlighting}
\end{Shaded}
...
(read more about \href{https://mran.microsoft.com/documents/rro/multithread}{``The Benefits of Multithreaded Performance with Microsoft R Open''}) is especially
...
\begin{itemize}
\item
  Grolemund, G., (2014) \href{https://rstudio-education.github.io/hopr/}{\textbf{Hands-On Programming with R}}. O'Reilly, 236 pages.
\item
  Gillespie, C., Lovelace, R., (2016) \href{https://csgillespie.github.io/efficientR/}{\textbf{Efficient R programming}}. O'Reilly, 222 pages.
\item
  Wilke, C.O., (2019) \href{https://serialmentor.com/dataviz/}{\textbf{Fundamentals of Data Visualization}}. O'Reilly, in press.
\end{itemize}
...
Other utility software that you might need include \texttt{htop} program that allows you to track processing progress:
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ls <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"reshape"}\NormalTok{, }\StringTok{"Hmisc"}\NormalTok{, }\StringTok{"rgdal"}\NormalTok{, }\StringTok{"raster"}\NormalTok{, }\StringTok{"sf"}\NormalTok{, }\StringTok{"GSIF"}\NormalTok{, }\StringTok{"plotKML"}\NormalTok{, }
        ...
        \StringTok{"quantregForest"}\NormalTok{, }\StringTok{"intamap"}\NormalTok{, }\StringTok{"fasterize"}\NormalTok{, }\StringTok{"viridis"}\NormalTok{)}
...
\CommentTok{#> GSIF version 0.5-5 (2019-01-04)}
\CommentTok{#> URL: http://gsif.r-forge.r-project.org/}
\end{Highlighting}
\end{Shaded}

A copy of the most-up-to-date and stable versions of plotKML and GSIF is also available on \href{https://github.com/cran/GSIF}{github}. To run only some specific function from the GSIF package you can do e.g.:
...
\CommentTok{#> This is aqp 1.17}
\CommentTok{#> }
\CommentTok{#> Attaching package: 'aqp'}
...
\CommentTok{#> plotKML version 0.5-9 (2019-01-04)}
...
\CommentTok{#>   Effective bytes    : 1202 }
...
\caption{Example of a plotKML output for geostatistical model and prediction.}\label{fig:ge-preview}
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{PSMwR_lulu_files/figure-latex/plot-eberg-ll-1} 
...
\item
  Bivand, R., Pebesma, E., Rubio, V., (2013) \href{http://www.asdar-book.org/}{\textbf{Applied Spatial Data Analysis with R}}. Use R Series, Springer, Heidelberg, 2nd Ed. 400 pages.
\item
  Lovelace, R., Nowosad, J., Muenchow, J., (2018) \href{https://geocompr.robinlovelace.net/}{\textbf{Geocomputation with R}}. R Series, CRC Press, 338 pages.
\end{itemize}
...
published as part of the specifications for the \emph{GlobalSoilMap} project \citep{arrouays2014globalsoilmap}.
...
Science Coordinator for the \emph{GlobalSoilMap} project (www.globalsoilmap.net).
We acknowledge the source of much of the content of this chapter as having
originated from the previously published \emph{GlobalSoilMap} specifications.
...
visit the main documentation page (\url{http://gsif.r-forge.r-project.org/}).
...
\citet{VanReeuwijk2002}. In this chapter we also make a distinction between the
\emph{`targeted variable'} (targeted soil properties) and \emph{`paths'} (determination methods).
...
\caption{Soil observations can refer to genetic horizons (left), fixed depths i.e. point support (center) and/or can refer to aggregate values for the complete profile (right).}\label{fig:soi-var-depth}
\end{figure}
...
\emph{12 soil properties} considered relevant for global analyses, and
...
\caption{Standard soil horizons, solum thickness and depth to bedrock (left) vs six standard depths used in the GlobalSoilMap project (right).}\label{fig:scheme-solum}
\end{figure}
...
assessed and reported relative to specific, designated \emph{reference methods}.
...
that were first mapped for the \url{https://soilgrids.org} project:
...
\item
  \emph{Definition of the reference methods used to assess the soil property
  value};
\item
...
repository \citep{Batjes2017ESSD}, and can be considered as an estimate of global prior
probabilities for soil pH (see further Fig. \ref{fig:sprops-phiho5}).

A general intention is to maintain a \emph{Global Soil Data Registry} so that
a short variable name (in further text \emph{``variable code''})
...
values. For example, a depth of 30 cm can be expressed as \citep{OGCKML2008}:
...
\caption{Depth to bedrock for censored and uncensored observations. Image source: Shangguan et al. (2017) doi: 10.1002/2016MS000686.}\label{fig:scheme-depth-to-bedrock}
\end{figure}
...
\BeginKnitrBlock{rmdnote}
Depth to bedrock is the mean distance to \texttt{R} horizon (layer
...
CaCO\(_3\) (carbonates) in g/kg, \texttt{GYP} is the CaSO\(_4\) (gypsum) in g/kg, and \texttt{tetaS}
...
{\centering \includegraphics[width=0.9\linewidth]{figures/Fig_sprofs_ORCDRC} 

}

\caption{Histogram and soil-depth density distribution for a global compilation of measurements of soil organic carbon content (ORCDRC) in permilles. Based on the records from WOSIS (http://www.earth-syst-sci-data.net/9/1/2017/). The log-transformation is used to ensure close-to-normal distribution in the histogram.}\label{fig:sprofs-soil-carbon}
\end{figure}
...
\citep{Aitken1991AJSR, Miller2010SSSAJ}. For example, \citet{Brennan1998} have estimated
...
\begin{itemize}
\item
  \emph{Nitrogen} (N) --- Nitrogen is often considered synonymous with
...
\item
  ...
  1.3 clay (fine particles \textless{}2 \(\mu\)m),
\item
  Coarse fragments (\textgreater{}2 mm)

  2.1 gravel (2 mm to 8 cm),

  2.2 stones or boulders (\textgreater{}8 cm),
\end{enumerate}
...
presence of \emph{`frequent stones'} contains only 90--127.5 tonnes organic carbon.
...
{\centering \includegraphics[width=0.9\linewidth]{figures/Fig_sprofs_CRFVOL} 
...
{\centering \includegraphics[width=0.85\linewidth]{figures/Fig_texture_limits_Minasny2001} 
...
{\centering \includegraphics[width=0.9\linewidth]{figures/Fig_sprofs_SNDPPT} 
...
{\centering \includegraphics[width=0.9\linewidth]{figures/Fig_sprofs_SLTPPT} 
...
{\centering \includegraphics[width=0.9\linewidth]{figures/Fig_sprofs_CLYPPT} 
...
\emph{bulk density of the fine earth fraction} (particles \textless{}2 mm) only. Calculations
...
contributor to bulk density prediction \citep{Heuscher2005SSSAJ}.
...
{\centering \includegraphics[width=0.9\linewidth]{figures/Fig_sprofs_BLD} 
...
\citet{Tranter2007SUM} proposed a conceptual model that incorporated \emph{a priori}
...
{\centering \includegraphics[width=1\linewidth]{figures/Fig_available_soil_water} 

}

\caption{Example of a soil-water plot. Actual water content can be measured using soil moisture probes i.e. automated sensor networks.}\label{fig:available-soil-water}
\end{figure}
...
\emph{``The development of hydraulic PTFs has become an industry''} \citep{Minasny2007JITL}.
Results of such research have been reported widely, including in the
USA \citep{Rawls1991AA}, UK, the Netherlands \citep{Wosten1995G}, and Germany. Research has attempted to
...
these cover only about 30\% of the total. \citet{Gijsman2007CEA} compared eight
...
the estimated values of wilting point or lower limit of \emph{plant extractable water}
(LL), \emph{field capacity} or the drained upper limit (DUL), and soil saturation (SAT).
They finally concluded that none of the methods were universally good.
The best method in the comparison of \citet{Gijsman2007CEA} was \citet{Saxton1986SSSAJ},
closely followed by \citet{Rawls1982JIDDASCE}.
...
concentration in permille, \texttt{BLD} is the bulk density in kg/m\(^3\), \texttt{CEC} is
the Cation Exchange Capacity, and \texttt{PHIHOX} is the soil pH in water
...
\hypertarget{harmonization-of-soil-data-and-pedo-transfer-functions}{%
\section{Harmonization of soil data and pedo-transfer functions}\label{harmonization-of-soil-data-and-pedo-transfer-functions}}

\hypertarget{basic-concepts-of-harmonization-of-soil-property-values}{%
\subsection{Basic concepts of harmonization of soil property values}\label{basic-concepts-of-harmonization-of-soil-property-values}}
...
interest for global soil mapping: The USDA's \emph{Soil Taxonomy}
...
required to reach a specific, more refined, class \citep{Krasilnikov2009handbook}.
...
\caption{The USDA-NRCS map of the Keys to Soil Taxonomy soil suborders of the world at 20 km. The map shows the distribution of 12 soil orders. The original map also contains assumed distributions for suborders e.g. Histels, Udolls, Calcids, and similar. Projected in the Robinson projection commonly used to display world maps.}\label{fig:worldmap-suborders}
\end{figure}
...
{\centering \includegraphics[width=0.55\linewidth,angle=0]{figures/Fig_USDA_categories} 

}

\caption{USDA classification system and approximate minimum number of observations required to fit a global multinomial regression model.}\label{fig:usda-categories}
\end{figure}
...
combination of predictor variables and observations \citep{harrell2001regression},
...
\hypertarget{variables-importing}{%
\section{Importing and formatting soil data in R}\label{variables-importing}}
...
{\centering \includegraphics[width=0.7\linewidth]{PSMwR_lulu_files/figure-latex/plot-tt-triangle-1} 
...
So knowing that the soil texture classes are defined geometrically, a logical estimate of the texture fractions from a class is to take the geometric centre of each polygon in the texture triangle. To estimate where the geometric centre is, we can for example use the functionality in the sp package. We start by creating a \texttt{SpatialPolygons} object, for which we have to calculate coordinates in the xy space and bind polygons one by one:
...
The resulting object now also contains \emph{slots} of type \texttt{labpt} which is exactly the geometric gravity point of the first polygon automatically derived by the \texttt{SpatialPolygons} function.
...
{\centering \includegraphics[width=0.7\linewidth]{PSMwR_lulu_files/figure-latex/plot-tt-afsis-1} 

}

\caption{Distribution of observed soil textures for the Africa Soil Profiles.}\label{fig:plot-tt-afsis}
\end{figure}
...
\subsection{Converting Munsell color codes to other color systems}\label{converting-munsell-color-codes-to-other-color-systems}}
...
Within the R \href{http://casoilresource.lawr.ucdavis.edu/drupal/node/201}{package aqp} one can directly transform Munsell color codes to standard color classes in R \citep{Beaudette2013CompGeo}. For example, to convert the Munsell color code to RGB values from the example above we would run:
...
To plot the actual colors based on an actual soil profile database we often need to prepare the color codes before we can run the conversion \citep{VISCARRAROSSEL2006320}. In the case of the \href{http://gsif.r-forge.r-project.org/afsp.html}{Africa Soil Profile Database}:
...
Next we need to format all Munsell color codes to \texttt{Hue\_Saturation\_Intensity} format. We can incrementally replace the existing codes until all codes can be matched with the RGB table:
...
{\centering \includegraphics[width=1\linewidth]{PSMwR_lulu_files/figure-latex/plot-af-soil-cols-1} 

}

\caption{Actual observed soil colors (moist) for the top soil based on the Africa Soil Profiles Database.}\label{fig:plot-af-soil-cols}
\end{figure}
...
\CommentTok{#>             id top bottom ORCDRC   hue value chroma soil_color hzID}
\CommentTok{#> 1 ISRIC:NG0017   0     18   18.4 7.5YR     3      2  #584537FF    1}
\CommentTok{#> 2 ISRIC:NG0017  18     36    4.4 7.5YR     4      4  #7E5A3BFF    2}
\CommentTok{#> 3 ISRIC:NG0017  36     65    3.6 2.5YR     5      6  #A96C4FFF    3}
\CommentTok{#> 4 ISRIC:NG0017  65     87    3.6   5YR     5      8  #B06A32FF    4}
\CommentTok{#> 5 ISRIC:NG0017  87    127    3.2   5YR     5      4  #9A7359FF    5}
\CommentTok{#> 6 ISRIC:NG0017 127    181    1.2  10YR     7      3  #C4AC8CFF    6}
\CommentTok{#> }
...
Once an object is in the format of \texttt{SoilProfileCollection} it can be directly plotted in Google Earth via the generic plotKML command:
...
\CommentTok{#> }
\CommentTok{#>  randomForestSRC 2.8.0 }
\CommentTok{#>  }
...
For model fitting we will use the \href{https://cran.r-project.org/package=randomForestSRC}{randomForestSRC} package, which is a robust implementation of the random forest algorithm with options for parallelization and visualization of model outputs:
...
For this purpose we also need to import the \emph{cleaned} legend for USDA classification:
...
SINFER concept would be to create and maintain a \textbf{Global Soil Reference Library}
...
available water capacity and \citet{Nemes1999G} for harmonization
...
This has been clearly identified first by \citet{jenny1994factors} with his CLORPT
factors of soil formation and subsequently extended by \citet{McBratney2003Geoderma}
...
\tightlist
\item
  Climate related covariates, which include:
\end{enumerate}
...
\tightlist
\item
  Vegetation and living organisms, which include:
\end{enumerate}
...
\tightlist
\item
  Relief and topography-related covariates, which include:
\end{enumerate}
...
\tightlist
\item
  Parent material / geologic material covariates, which include:
\end{enumerate}
...
\tightlist
\item
  Estimated geological age of surface, which include:
\end{enumerate}
...
\tightlist
\item
  Spatial position or spatial context, which include:
\end{enumerate}
...
\tightlist
\item
  Human or Anthropogenic Influences, which include:
\end{enumerate}
...
RS data processing hub such as \href{http://www.sentinel-hub.com}{Sentinel hub},
\href{https://earthengine.google.com}{Google Earth Engine} and/or
\href{https://aws.amazon.com/public-datasets/}{Amazon Web Services} instead of trying
...
\begin{itemize}
\item
  WorldDEM (\url{https://worlddem-database.terrasar.com}) at 12 m resolution multiband elevation products,
\item
  German hyperspectral satellite mission EnMAP (\url{http://www.enmap.org}) products, which have shown to be useful for mapping soil nutrients and minerals \citep{rs8070613},
\item
  Sentinel-1 soil moisture products, currently limited to 1 km to 500 m resolutions but available at fast revisit times \citep{Bauer-Marschallinger2019},
\end{itemize}
...
derivatives \citep{Behrens2018128}.
...
{\centering \includegraphics[width=0.7\linewidth]{PSMwR_lulu_files/figure-latex/eberg-zones-spplot-1} 
...
The \texttt{eberg\_grids25} object is a \texttt{SpatialPixelsDataFrame}, which is a spatial gridded data structure of the \href{https://cran.r-project.org/web/packages/sp/}{sp package} package. The raster package also offers data structures for spatial (gridded) data, and stores such data as \texttt{RasterLayer} class. Gridded data can be converted from class \texttt{SpatialPixelsDataFrame} to a \texttt{Raster} layer with the \href{http://www.rdocumentation.org/packages/raster/functions/raster}{\texttt{raster}} command. The
...
{\centering \includegraphics[width=0.7\linewidth]{PSMwR_lulu_files/figure-latex/eberg-zones-grid-1} 

}

\caption{Ebergotzen parent material polygon map rasterized to 25 m spatial resolution.}\label{fig:eberg-zones-grid}
\end{figure}
...
\texttt{fasterize} function is an order of magnitude faster and hence more suitable for operational work; it only works with Simple Feature (sf) objects, however, so the \texttt{sp} polygon object needs to be first coerced to an \texttt{sf} object.

Another efficient approach to rasterize polygons is to use SAGA GIS, which can handle large data and is easy to run in parallel. First, you need to export the polygon map to shapefile format which can be done with commands of the \href{https://cran.r-project.org/web/packages/rgdal/}{rgdal package} package:
...
and finally use the module \texttt{grid\_gridding} to convert the shapefile to a grid:
...
{\centering \includegraphics[width=0.55\linewidth]{figures/eberg_zones_rasterized} 

}

\caption{Ebergotzen zones rasterized to 25 m resolution and with correct factor labels.}\label{fig:eberg-zones-rasterized}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dem.lst <-}\StringTok{ }\KeywordTok{list.files}\NormalTok{(}\StringTok{"extdata"}\NormalTok{, }\DataTypeTok{pattern=}\KeywordTok{glob2rx}\NormalTok{(}\StringTok{"^DEMSRT6_*.sdat"}\NormalTok{), }\DataTypeTok{full.names =} \OtherTok{TRUE}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(raster}\OperatorTok{::}\KeywordTok{stack}\NormalTok{(dem.lst), }\DataTypeTok{col=}\KeywordTok{rev}\NormalTok{(}\KeywordTok{magma}\NormalTok{(}\DecValTok{10}\NormalTok{, }\DataTypeTok{alpha =} \FloatTok{0.8}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
In this example we use the same input and output file for filling in gaps. There are several other gap filling possibilities in SAGA GIS including Close Gaps with Spline, Close Gaps with Stepwise Resampling and Close One Cell Gaps. Not all of these are equally applicable to all missing pixel problems, but having \textless{}10\% of missing pixels is often not much of a problem for soil mapping.

Another elegant way to filter the missing pixels, to reduce noise and to reduce data overlap is to use \href{http://www.rdocumentation.org/packages/stats/functions/prcomp}{Principal Components} transformation of original data. This is available also via the GSIF function \texttt{spc}:
...
\caption{11 PCs derived using input Ebergotzen covariates.}\label{fig:eberg-spc-11-plot}
\end{figure}

The advantages of using the \texttt{spc} function are:
...
One could now save all the prepared covariates stored in \texttt{SpatialGridDataFrame} as an RDS data object for future use.
...
\caption{A tile produced from a satellite image in the example in the previous figure.}\label{fig:sp27gtif-tile}
\end{figure}
...
This can now be run through the \texttt{mclapply} function from the parallel package (which automatically employs all available cores):
...
\texttt{-overwrite\ -co\ "COMPRESS=DEFLATE"} to overwrite the GeoTiff and internally
compress it to save space, and \texttt{-r\ "near"} basically specifies that
no resampling is applied, just binding of tiles together. Also, if the
output GeoTiff is HUGE, you will most likely have to turn on \texttt{-co\ "BIGTIFF=YES"}
otherwise \texttt{gdalwarp} would not run through. The output mosaic looks like this:
...
using \texttt{gdalwarp}.

Note that such \emph{tiling} and \emph{stitching} can not be applied universally to all
...
\citep[ p.133]{Burrough1998OUP, Webster2001Wiley}:
...
Similar \emph{spatial support}-effects show up in the horizontal,
...
\item
  ...
  \textbf{prediction error map}.
\end{enumerate}

It is clear from Fig. \ref{fig:general-sp-process} that
the key steps in the mapping procedure are: (a) \emph{choice of the sampling scheme} (e.g. \citet{Ng2018} and \citet{BRUS2019464}),
...
\citet{Webster2001Wiley}, \citet{tan2005soil}, \citet{Legros2006SP} and \citet{BRUS2019464}. Some general
...
\caption{Occurrence probabilities derived for the actual sampling locations (left), and for a purely random sample design with exactly the same number of points (right). Probabilities derived using the `spsample.prob` function from the GSIF package. The shaded area on the left indicates which areas (in the environmental space) have been systematically represented, while the white colour indicates areas which have been systematically omitted (and which is not by chance).}\label{fig:eberg-sampling-locs}
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{figures/Fig_catena_Maungawhau_A} 
...
{\centering \includegraphics[width=0.9\linewidth]{figures/Fig_catena_Maungawhau_B} 
...
\citep[ ch3.8]{Diggle2007Springer} in which the Gaussian geostatistical model
...
Statistical treatment of many of these methods is given in \citet{hastie2009elements} and \citet{kuhn2013applied}.
...
Eq.\eqref{eq:clorpt2} suggests that soil is a result of environmental
factors, while in reality there are many feedbacks and soil, in turn, influences
many of the factors on the right-hand side of Eq.\eqref{eq:clorpt2}, such
as \(cl\), \(o\) and \(r\).
...
Eq.\eqref{eq:UKvar2}, one can also derive a simplified regression-kriging
...
{\centering \includegraphics[width=0.9\linewidth]{figures/Fig_RK_vs_randomForestK_Meuse} 
...
for the random forest model using the quantregForest package \citep{meinshausen2006quantile}
...
{\centering \includegraphics[width=1.05\linewidth]{figures/Fig_hist_om_predicted_vs_simulated} 

}

\caption{Histogram for the target variable (Meuse data set; log of organic matter) based on the actual observations (left), predictions at all grid nodes (middle) and simulations (right). Note that the histogram for predicted values will always show somewhat narrower distribution (smoothed), depending on the strength of the model, while the simulations should be able to reproduce the original range (for more discussion see also: Yamamoto et al. (2008)).}\label{fig:hist-om-predicted-simulated}
\end{figure}
...
\CommentTok{#> R 2019-03-17 16:41:33 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 159.72396788006"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x140178c0> }
...
\caption{A modern workflow of predictive soil mapping. This often includes state-of-the-art Machine Learning Algorithms. Image source: Hengl et al. (2017) doi: 10.1371/journal.pone.0169748.}\label{fig:scheme-statmodels}
\end{figure}
...
\KeywordTok{bwplot}\NormalTok{(resamps, }\DataTypeTok{layout =} \KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{, }\DecValTok{1}\NormalTok{), }\DataTypeTok{metric=}\KeywordTok{c}\NormalTok{(}\StringTok{"RMSE"}\NormalTok{,}\StringTok{"Rsquared"}\NormalTok{), }
       \DataTypeTok{fill=}\StringTok{"grey"}\NormalTok{, }\DataTypeTok{scales =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{relation =} \StringTok{"free"}\NormalTok{, }\DataTypeTok{cex =} \FloatTok{.7}\NormalTok{), }
       \DataTypeTok{cex.main =} \FloatTok{.7}\NormalTok{, }\DataTypeTok{cex.axis =} \FloatTok{.7}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \includegraphics[width=0.6\linewidth]{PSMwR_lulu_files/figure-latex/bwplot-meuse-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{figures/Fig_voxel_scheme} 
...
interest (see also: \texttt{RasterStack} class in the raster package). In the case of
...
{\centering \includegraphics[width=0.7\linewidth]{figures/Fig_multiscale_vs_multisource} 
...
{\centering \includegraphics[width=0.6\linewidth]{figures/Fig_cross_validation_types} 
...
the e.g.~gstat package (\texttt{krige.cv} methods), which makes this type of
...
\KeywordTok{hist}\NormalTok{(om.rk.cv}\OperatorTok{$}\NormalTok{zscore, }\DataTypeTok{main =} \StringTok{"Z-scores histogram"}\NormalTok{, }
     ...
     \DataTypeTok{cex.axis =} \FloatTok{.7}\NormalTok{, }\DataTypeTok{cex.main =} \FloatTok{.7}\NormalTok{, }\DataTypeTok{cex.lab =} \FloatTok{.7}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \includegraphics[width=0.65\linewidth]{PSMwR_lulu_files/figure-latex/z-scores-histogram-1} 
...
{\centering \includegraphics[width=0.75\linewidth]{figures/Fig_difference_accuracy_reliability} 
...
{\centering \includegraphics[width=0.8\linewidth]{PSMwR_lulu_files/figure-latex/confidence-limits-boxplot-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{figures/Fig_validation_plots} 
...
\hypertarget{mapping-accuracy-soil-survey-costs}{%
\subsection{Mapping accuracy and soil survey costs}\label{mapping-accuracy-soil-survey-costs}}
...
{\centering \includegraphics[width=0.85\linewidth]{figures/Fig_scale_costs_ratio} 

}

\caption{Some basic concepts of soil survey costs: (a) relationship between cartographic scale and pixel size (Hengl, 2006), (b) soil survey costs and scale relationship based on the empirical data of (Legros, 2006).}\label{fig:scale-costs-ratio}
\end{figure}
...
i.e.~about 4 USD per ha \citep{Durana2008}; in Canada, typical costs of producing
...
{\centering \includegraphics[width=0.65\linewidth]{figures/Fig_costs_RMSE_scheme-2} 
...
predictions \citep{brungard2015machine, heung2016overview, behrens2018multi}.
In this tutorial we especially focus on using tree-based algorithms such as \href{https://en.wikipedia.org/wiki/Random_forest}{random forest}, \href{https://en.wikipedia.org/wiki/Gradient_boosting}{gradient boosting} and \href{https://cran.r-project.org/package=Cubist}{Cubist}.
For a more in-depth overview of machine learning algorithms used in statistics
refer to the CRAN Task View on \href{https://cran.r-project.org/web/views/MachineLearning.html}{Machine Learning \& Statistical Learning}.
...
We can also test some other MLA's that are suited for this data --- \texttt{multinom} from the \href{https://cran.r-project.org/package=nnet}{nnet} package, and \texttt{svm} (Support Vector Machine) from the \href{https://cran.r-project.org/package=e1071}{e1071} package:
...
{\centering \includegraphics[width=1\linewidth]{PSMwR_lulu_files/figure-latex/plot-eberg-soiltype-1} 
...
\CommentTok{#>     R Version:                  R version 3.5.2 (2017-01-27)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> Mean Residual Deviance :  222}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> The following object is masked from 'package:viridis':}
\CommentTok{#> }
\CommentTok{#>     viridis_pal}
...
{\centering \includegraphics[width=0.4\linewidth]{figures/Measured_vs_predicted_SAND_plot} 
...
{\centering \includegraphics[width=0.8\linewidth]{PSMwR_lulu_files/figure-latex/map-snd-1} 
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1552840950825_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.016053 0.009161}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.140211 0.195716}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001313 0.000899}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.003055   0.101850  0.362292 0.064588}
\CommentTok{#> 3 0.000000   -0.018418   0.071368  0.954337 0.021435}
\CommentTok{#> 4 0.000000    0.001017   0.049089  0.112493 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> }
\CommentTok{#> MSE:  261}
\CommentTok{#> RMSE:  16.1}
\CommentTok{#> MAE:  12.3}
\CommentTok{#> RMSLE:  0.496}
\CommentTok{#> Mean Residual Deviance :  261}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.8\linewidth]{PSMwR_lulu_files/figure-latex/map-snd-dl-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{PSMwR_lulu_files/figure-latex/map-snd-ensemble-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{figures/horizon_depths_for_3d_modeling_scheme} 
...
{\centering \includegraphics[width=0.7\linewidth]{PSMwR_lulu_files/figure-latex/varimp-plot-edgeroi-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{PSMwR_lulu_files/figure-latex/maps-soc-edgeroi-1} 

}

\caption{Comparison of three MLA's and the final ensemble prediction (ORCDRC 5cm) of soil organic carbon content for 2.5 cm depth.}\label{fig:maps-soc-edgeroi}
\end{figure}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 15.57 10.83 8.82 5.72 3.69 ...}
...
\CommentTok{#>   ..$ ME          : num -0.123}
\CommentTok{#>   ..$ MAE         : num 2.13}
\CommentTok{#>   ..$ RMSE        : num 3.63}
\CommentTok{#>   ..$ R.squared   : num 0.57}
\CommentTok{#>   ..$ logRMSE     : num 0.484}
\CommentTok{#>   ..$ logR.squared: num 0.65}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{plt0 <-}\StringTok{ }\KeywordTok{xyplot}\NormalTok{(test.ORC[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{Observed }\OperatorTok{~}\StringTok{ }\NormalTok{test.ORC[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{Predicted, }\DataTypeTok{asp=}\DecValTok{1}\NormalTok{, }
            \DataTypeTok{par.settings =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{plot.symbol =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{col=}\NormalTok{scales}\OperatorTok{::}\KeywordTok{alpha}\NormalTok{(}\StringTok{"black"}\NormalTok{, }\FloatTok{0.6}\NormalTok{), }\DataTypeTok{fill=}\NormalTok{scales}\OperatorTok{::}\KeywordTok{alpha}\NormalTok{(}\StringTok{"red"}\NormalTok{, }\FloatTok{0.6}\NormalTok{), }\DataTypeTok{pch=}\DecValTok{21}\NormalTok{, }\DataTypeTok{cex=}\FloatTok{0.6}\NormalTok{)), }
            \DataTypeTok{scales =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{x=}\KeywordTok{list}\NormalTok{(}\DataTypeTok{log=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{equispaced.log=}\OtherTok{FALSE}\NormalTok{), }\DataTypeTok{y=}\KeywordTok{list}\NormalTok{(}\DataTypeTok{log=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{equispaced.log=}\OtherTok{FALSE}\NormalTok{)),}
            \DataTypeTok{ylab=}\StringTok{"measured"}\NormalTok{, }\DataTypeTok{xlab=}\StringTok{"predicted (machine learning)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.4\linewidth]{figures/Predicted_vs_observed_plot_for_SOC_edgeroi} 
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.81}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.67670119633791}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1294}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0755}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0742393371581637}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8166}
\CommentTok{#> SL.ksvm_All    0.1290 0.0133}
\CommentTok{#> SL.glmnet_All  0.3076 0.0000}
\CommentTok{#> SL.ranger_All  0.0850 0.1701}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.0832 0.19}
\CommentTok{#> SL.ksvm_All    0.1298 0.00}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   Super Learner 0.16 0.014 0.098 0.26}
\CommentTok{#>     Discrete SL 0.17 0.014 0.118 0.25}
...
\CommentTok{#> SL.ranger_All  0.166 0.459}
\CommentTok{#> SL.ksvm_All    0.163 0.541}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.64 4.71 4.85 4.82 4.75 ...}
...
{\centering \includegraphics[width=1\linewidth]{PSMwR_lulu_files/figure-latex/ph-cookfarm-1} 
...
{\centering \includegraphics[width=0.75\linewidth]{PSMwR_lulu_files/figure-latex/ph-cookfarm-var-1} 
...
and similar are used for prediction has been also proposed by \citet{Behrens2018EJSS}.
...
The \href{https://cran.r-project.org/package=gdistance}{gdistance} package, for example, provides a framework to derive complex
...
\caption{Examples of distance maps to some location in space (yellow dot) based on different derivation algorithms: (a) simple Euclidean distances, (b) complex speed-based distances based on the gdistance package and Digital Elevation Model (DEM), and (c) upslope area derived based on the DEM in SAGA GIS. Image source: Hengl et al. (2018) doi: 10.7717/peerj.5518.}\label{fig:distances-examples}
\end{figure}
...
If no other information is available, we can use buffer distances to all points as covariates to predict values of some continuous or categorical variable in the RFsp framework. These can be derived with the help of the \href{https://cran.r-project.org/package=raster}{raster} package \citep{raster}. Consider for example the meuse data set from the sp package:
...
\KeywordTok{plot}\NormalTok{(vv <-}\StringTok{ }\KeywordTok{t}\NormalTok{(}\KeywordTok{data.frame}\NormalTok{(xl[}\KeywordTok{order}\NormalTok{(}\KeywordTok{unlist}\NormalTok{(xl), }\DataTypeTok{decreasing=}\OtherTok{TRUE}\NormalTok{)[}\DecValTok{10}\OperatorTok{:}\DecValTok{1}\NormalTok{]])), }\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{, }
     ...
     \DataTypeTok{cex.axis =} \FloatTok{.7}\NormalTok{, }\DataTypeTok{cex.lab =} \FloatTok{.7}\NormalTok{)}
...
\KeywordTok{axis}\NormalTok{(}\DecValTok{2}\NormalTok{, }\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{, }\DataTypeTok{labels =} \KeywordTok{dimnames}\NormalTok{(vv)[[}\DecValTok{1}\NormalTok{]], }\DataTypeTok{las =} \DecValTok{2}\NormalTok{, }\DataTypeTok{cex.axis =} \FloatTok{.7}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \includegraphics[width=0.65\linewidth]{PSMwR_lulu_files/figure-latex/rf-variableImportance-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{figures/Fig_RF_covs_bufferdist_zinc_meuse} 
...
\def\labelenumi{\arabic{enumi}.}
\item
  Non-linear relationships between soil forming factors and soil properties
  can be more efficiently modeled using MLA's,
\item
  Tree-based MLA's (random forest, gradient boosting, cubist) are suitable
  for representing \emph{local} soil-landscape relationships, nested within a
...
This chapter was prepared as supplementary material for the \citet{sanderman2018soil} article. It explains how to map Soil Organic Carbon Stocks (OCS) using soil samples (point data). It also demonstrates derivation of values at both the site level (per profile) and by using raster calculus (per pixel). We then illustrate how to estimate total OCS for any area of interest (which can be a field plot, farm and/or administrative region). For an introduction to soil mapping using Machine Learning Algorithms refer to chapter \ref{soilmapping-using-mla}. To access the ISRIC global compilation of soil profiles referenced here please refer to: \url{http://www.isric.org/explore/wosis}
...
\citep{Scharlemann2014CM}. Current estimates of the present total soil organic
...
{\centering \includegraphics[width=0.8\linewidth]{figures/fig_2_profiles_ocs_edgeroi} 
...
In the second example we look at a profile from Canada (a histosol with \textgreater{}40\% of organic carbon; \citet{shaw2005ecosystem}) which is shown in Tbl. \ref{tab:profile-can}.
...
{\centering \includegraphics[width=0.8\linewidth]{figures/fig_2_profiles_ocs_organic} 
...
{\centering \includegraphics[width=0.9\linewidth]{figures/Fig_standard_soil_profiles_SOC_calc} 
...
Where values for bulk density are missing, and no local PTF exists, WoSIS points (global compilation of soil profiles) can be used to fit a PTF that can fill-in gaps in bulk density measurements globally. A regression matrix extracted on 15th of May 2017 (and which contains harmonized values for BD, organic carbon content, pH, sand and clay content, depth of horizon and USDA soil type at some 20,000 soil profiles world-wide), can be fitted using a random forest model (see also \citet{Ramcharan2017}):
...
\CommentTok{#> Growing trees.. Progress: 85%. Estimated remaining time: 5 seconds.}
\NormalTok{m.BLD_PTF}
\CommentTok{#> Ranger result}
\CommentTok{#> }
\CommentTok{#> Call:}
...
{\centering \includegraphics[width=0.9\linewidth]{figures/fig_derivation_socs_scheme} 
...
{\centering \includegraphics[width=0.65\linewidth]{figures/fig_la_libertad_research_center_socs} 
...
{\centering \includegraphics[width=0.75\linewidth]{PSMwR_lulu_files/figure-latex/plot-cosha30map-rf-1} 
...
The Edgeroi completely lacks any BLD values, therefore before we can compute OCD values, we need to estimate BLD values for each corresponding horizon. Here the easiest option is probably to use BLD values sourced from LandGIS predictions (and which you can download from \url{https://landgis.opengeohub.org}).
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ov.edgeroi.BLDm  <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{BLD.f =} \KeywordTok{as.vector}\NormalTok{(}\KeywordTok{sapply}\NormalTok{(}\DecValTok{2}\OperatorTok{:}\KeywordTok{ncol}\NormalTok{(ov.edgeroi.BLD),}
                            \ControlFlowTok{function}\NormalTok{(i)\{}\KeywordTok{rowMeans}\NormalTok{(ov.edgeroi.BLD[,}\KeywordTok{c}\NormalTok{(i}\DecValTok{-1}\NormalTok{,i)])\})),}
...
\CommentTok{#> R squared (OOB):                  0.697}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.7\linewidth]{PSMwR_lulu_files/figure-latex/plot-edgeroi-ocd-1} 

}

\caption{Predicted organic carbon stock for 0–30 cm depth for the Edgeroi data set. All values expressed in tons/ha.}\label{fig:plot-edgeroi-ocd}
\end{figure}

\begin{figure}[H]

{\centering \includegraphics[width=0.7\linewidth]{PSMwR_lulu_files/figure-latex/plot-edgeroi-ocd-error-1} 

}

\caption{The prediction error map for the Edgeroi data set.}\label{fig:plot-edgeroi-ocd-error}
\end{figure}
...
\CommentTok{#> 4                  Cotton - irrigated          808      203         40}
\CommentTok{#> 5   Cropping - continuous or rotation         1803      402         45}
...
\CommentTok{#> 16                     Irrigation dam           63       16         39}
...
\CommentTok{#> 33 Volunteer, naturalised, native or            62       16         39}
\CommentTok{#> 34 Volunteer, naturalised, native or            77       14         55}
\CommentTok{#> 35 Volunteer, naturalised, native or           475       99         48}
\CommentTok{#> 37 Wide road reserve or TSR, with som          467       90         52}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{hist}\NormalTok{(OCD_stN}\OperatorTok{$}\NormalTok{YEAR, }\DataTypeTok{xlab=}\StringTok{"Year"}\NormalTok{, }\DataTypeTok{main=}\StringTok{""}\NormalTok{, }\DataTypeTok{col=}\StringTok{"darkgrey"}\NormalTok{, }\DataTypeTok{cex.axis =} \FloatTok{.7}\NormalTok{, }\DataTypeTok{cex.main =} \FloatTok{.7}\NormalTok{, }\DataTypeTok{cex.lab =} \FloatTok{.7}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \includegraphics[width=0.75\linewidth]{PSMwR_lulu_files/figure-latex/thist-usa48-1} 
...
which shows that the most important soil covariate by far is soil depth, followed by elevation, grazing, MODIS cloud fraction images, cropland and similar. For a full description of codes please refer to \citet{sanderman2018soil}.
...
{\centering \includegraphics[width=0.9\linewidth]{figures/usa48_ocd_10cm_year2014} 
...
{\centering \includegraphics[width=0.9\linewidth]{figures/usa48_ocd_10cm_year1925} 
...
{\centering \includegraphics[width=0.9\linewidth]{figures/Fig_decisiontree_PSM_project} 
...
\item
  PSM projects aimed at optimizing predictions and usability ---
...
{\centering \includegraphics[width=0.6\linewidth]{figures/Fig_types_of_PSM_projects} 
...
\item
  ...
  that supports reproducibility and return sampling \citep{BRUS2019464, Malone2019PeerJ}.
\item
...
{\centering \includegraphics[width=0.85\linewidth]{figures/Fig_soil_mask_scheme} 
...
\caption{Example of an AWS dedicated server running spatial predictions on 96 threads and using almost 500GB of RAM. Renting out this server can cost up to 8 USD per hour.}\label{fig:aws-htop-server}
\end{figure}
...
\item
  ...
  sampling design \citep{brown2015spatially, stumpf2017uncertainty, BRUS2019464},
  ...
  \item
    ...
    \begin{itemize}
    \item
      Conditioned Latin Hypercube (cLHC) sampling \citep{Malone2019PeerJ},
    \item
...
\citep{stumpf2016incorporating, Malone2019PeerJ}. Potential point sample
...
spatial predictions \citep{stumpf2017uncertainty}. The spatially located measures of uncertainty
...
e.g.~field, lab, data entry). Persistent and unique machine readable identifiers can help to
...
\citet{BRUS2019464} provides a systematic overview of sampling techniques and \href{https://github.com/DickBrus/TutorialSampling4DSM}{how
to implement them in R}.
The author also recongizes that \emph{``further research is recommended on sampling
...
instruments such as ground penetrating radar \citep{gerber2010applicability}, electrical conductivity
and gamma ray spectroscopy \citep{rouze2017understanding} are also becoming increasingly available and
...
Portable MIR scanners achieve almost the same accuracy as laboratories \citep{s18040993}.
...
on reproducibility and accuracy \citep{shepherd2002development, ShepherdWalsh2007JNIS}. A modern soil laboratory now entails
...
US\$ 2--10 per profile \citep{ShepherdWalsh2007JNIS, ViscarraRossel2016198}.
...
spectroscopy \citep{wilford1997application, viscarra2007multivariate, rouze2017understanding}.
...
parent material such as texture, and to a lesser extent, mineralogy \citep{liu2012soil}.
...
spatial context or spatial position (n) in the scorpan model \citep{Behrens2018EJSS}. These
...
process scales and formative influences \citep{Behrens2018EJSS, behrens2018multi}.
...
OPEN Data based on the Sunlight Foundation's \emph{``Ten Principles for Opening up Government Information''}
...
{\centering \includegraphics[width=0.95\linewidth]{figures/Fig_soil_type_workflow.svg} 

}

\caption{LandGIS as a system for generating new added-value information immediately and affordably using “old legacy data” i.e. without new investments. By importing, cleaning up and data mining of legacy soil data we promote technology and knowledge transfer from data-rich countries to data-poor countries.}\label{fig:soil-type-workflow}
\end{figure}
