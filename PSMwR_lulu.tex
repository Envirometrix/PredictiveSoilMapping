...
\CommentTok{#> R 2019-01-26 16:26:44 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 162.230886160451"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x15155140> }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1548520061951_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.013957 0.007703}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.136275 0.188131}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001342 0.000949}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000   -0.001044   0.103508  0.377631 0.055975}
\CommentTok{#> 3 0.000000   -0.017842   0.070827  0.958265 0.017451}
\CommentTok{#> 4 0.000000    0.001807   0.052380  0.092688 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.22 10.01 9.3 5.82 3.56 ...}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.30}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.34831023473735}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1359}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0757}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.075596719707661}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.81188}
\CommentTok{#> SL.ksvm_All    0.1290 0.00723}
\CommentTok{#> SL.glmnet_All  0.3080 0.00000}
\CommentTok{#> SL.ranger_All  0.0849 0.18089}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> }
\CommentTok{#>                  Risk  Coef}
\CommentTok{#> SL.xgboost_All 0.0603 0.809}
\CommentTok{#> SL.ranger_All  0.0830 0.191}
...
\CommentTok{#>     Discrete SL 0.17 0.014 0.110 0.25}
\CommentTok{#>  SL.xgboost_All 0.19 0.016 0.135 0.27}
\CommentTok{#>   SL.ranger_All 0.16 0.014 0.105 0.25}
...
\CommentTok{#> SL.ranger_All  0.165 0.469}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.65 4.72 4.86 4.82 4.76 ...}
