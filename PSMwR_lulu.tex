...
\tightlist
\item
  Hengl, T., MacMillan, R.A., (2019). \textbf{Predictive Soil Mapping with R}. OpenGeoHub foundation, Wageningen, the Netherlands, 376 pages, www.soilmapper.org, ISBN: 978-0-359-30635-0.
\end{itemize}
...
{\centering \includegraphics[width=0.65\linewidth]{figures/eberg_zones_rasterized} 
...
\CommentTok{#> R 2019-02-07 21:15:26 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> condition number 0}
\CommentTok{#> [1] "estimated time for  copula 161.774734550472"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x140259e0> }
...
\CommentTok{#>     /tmp/RtmpdykC3b/h2o_travis_started_from_r.out}
\CommentTok{#>     /tmp/RtmpdykC3b/h2o_travis_started_from_r.err}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> Starting H2O JVM and connecting: .. Connection successful!}
\CommentTok{#> }
\CommentTok{#> R is connected to the H2O cluster: }
\CommentTok{#>     H2O cluster uptime:         2 seconds 378 milliseconds }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1549574187630_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.014641 0.008781}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.139003 0.191311}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001409 0.000944}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.001810   0.102720  0.356266 0.065044}
\CommentTok{#> 3 0.000000   -0.018441   0.070942  0.954793 0.021691}
\CommentTok{#> 4 0.000000   -0.001356   0.050444  0.110330 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> }
\CommentTok{#> MSE:  285}
\CommentTok{#> RMSE:  16.9}
\CommentTok{#> MAE:  13.1}
\CommentTok{#> RMSLE:  0.525}
\CommentTok{#> Mean Residual Deviance :  285}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 15.15 10.49 9.6 6.87 3.37 ...}
...
\CommentTok{#>   ..$ ME          : num -0.0992}
\CommentTok{#>   ..$ MAE         : num 2.11}
\CommentTok{#>   ..$ RMSE        : num 3.6}
\CommentTok{#>   ..$ R.squared   : num 0.576}
\CommentTok{#>   ..$ logRMSE     : num 0.477}
\CommentTok{#>   ..$ logR.squared: num 0.659}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.38061809277088}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1457}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0799}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0761763199377818}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8094}
\CommentTok{#> SL.ksvm_All    0.1285 0.0103}
\CommentTok{#> SL.glmnet_All  0.3076 0.0000}
\CommentTok{#> SL.ranger_All  0.0849 0.1802}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   Super Learner 0.16 0.014 0.098 0.25}
\CommentTok{#>     Discrete SL 0.17 0.014 0.117 0.25}
...
\CommentTok{#> SL.ranger_All  0.168 0.451}
\CommentTok{#> SL.ksvm_All    0.163 0.549}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.65 4.72 4.87 4.83 4.75 ...}
...
{\centering \includegraphics[width=0.8\linewidth]{PSMwR_lulu_files/figure-latex/rf-variableImportance-1} 
...
\CommentTok{#> Growing trees.. Progress: 81%. Estimated remaining time: 7 seconds.}
\NormalTok{m.BLD_PTF}
\CommentTok{#> Ranger result}
\CommentTok{#> }
\CommentTok{#> Call:}
