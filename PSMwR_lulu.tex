...
\CommentTok{#> R 2019-02-16 16:10:03 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 154.905401802103"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x14755a98> }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1550333462314_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.015644 0.009188}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.140206 0.175742}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001245 0.000789}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.005869   0.101121  0.347194 0.070533}
\CommentTok{#> 3 0.000000   -0.018776   0.071375  0.953097 0.023147}
\CommentTok{#> 4 0.000000   -0.000295   0.046754  0.095616 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> }
\CommentTok{#> MSE:  270}
\CommentTok{#> RMSE:  16.4}
\CommentTok{#> MAE:  12.7}
\CommentTok{#> RMSLE:  0.508}
\CommentTok{#> Mean Residual Deviance :  270}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.56 10.86 9.6 5.97 3.17 ...}
...
\CommentTok{#>   ..$ ME          : num -0.107}
\CommentTok{#>   ..$ MAE         : num 2.13}
\CommentTok{#>   ..$ RMSE        : num 3.63}
\CommentTok{#>   ..$ R.squared   : num 0.57}
\CommentTok{#>   ..$ logRMSE     : num 0.481}
\CommentTok{#>   ..$ logR.squared: num 0.654}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.57510489646351}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1339}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0805}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0801675368647561}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.824}
\CommentTok{#> SL.ksvm_All    0.1290 0.018}
\CommentTok{#> SL.glmnet_All  0.3077 0.000}
\CommentTok{#> SL.ranger_All  0.0858 0.158}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> }
\CommentTok{#>                  Risk  Coef}
\CommentTok{#> SL.xgboost_All 0.0603 0.821}
\CommentTok{#> SL.ranger_All  0.0840 0.179}
\CommentTok{#> SL.ksvm_All    0.1302 0.000}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.165 0.468}
\CommentTok{#> SL.ksvm_All    0.162 0.532}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.61 4.68 4.82 4.79 4.73 ...}
...
\CommentTok{#> Growing trees.. Progress: 84%. Estimated remaining time: 6 seconds.}
\NormalTok{m.BLD_PTF}
\CommentTok{#> Ranger result}
\CommentTok{#> }
\CommentTok{#> Call:}
