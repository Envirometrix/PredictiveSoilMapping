...
\CommentTok{#> R 2019-02-10 11:08:54 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 160.373749976055"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x15014438> }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1549796992918_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.015005 0.009024}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.119913 0.180131}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001284 0.000912}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.005565   0.102063  0.357720 0.063577}
\CommentTok{#> 3 0.000000   -0.017922   0.071761  0.955822 0.019207}
\CommentTok{#> 4 0.000000    0.007695   0.051977  0.090935 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> MAE:  12.5}
\CommentTok{#> RMSLE:  0.501}
\CommentTok{#> Mean Residual Deviance :  263}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.24 10.53 8.49 5.97 3.08 ...}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.51}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.30381527784003}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1350}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0806}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.079891667599262}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8170}
\CommentTok{#> SL.ksvm_All    0.1280 0.0148}
\CommentTok{#> SL.glmnet_All  0.3080 0.0000}
\CommentTok{#> SL.ranger_All  0.0852 0.1682}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.0833 0.188}
\CommentTok{#> SL.ksvm_All    0.1298 0.000}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>     Discrete SL 0.17 0.014 0.109 0.25}
...
\CommentTok{#> SL.ranger_All  0.164 0.49}
\CommentTok{#> SL.ksvm_All    0.163 0.51}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.67 4.75 4.9 4.86 4.8 ...}
