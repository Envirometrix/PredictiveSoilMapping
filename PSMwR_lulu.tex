...
geoinformation science and a number of other sciences \citep{Scul01, MCBRATNEY20033, Henderson2004Geoderma, Boettinger2010Springer, Zhu2015PSM}. \emph{Predictive Soil Mapping with R}
...
\citet{MCBRATNEY20033} re-conceptualized and extended the CLORPT model via the
...
This has been clearly identified first by \citet{jenny1994factors} with his CLORPT factors of soil formation and subsequently extended by \citet{MCBRATNEY20033} with the SCORPAN formulation (see section \ref{soil-mapping-theory}).
...
\CommentTok{#> R 2019-03-13 15:56:47 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 160.350817657873"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x140bbbc8> }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1552492665822_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.013779 0.007958}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.186861 0.213802}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001565 0.001012}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.003430   0.101738  0.325653 0.075387}
\CommentTok{#> 3 0.000000   -0.019410   0.071137  0.945776 0.025077}
\CommentTok{#> 4 0.000000    0.004578   0.046636  0.113470 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> }
\CommentTok{#> MSE:  306}
\CommentTok{#> RMSE:  17.5}
\CommentTok{#> MAE:  13.6}
\CommentTok{#> RMSLE:  0.542}
\CommentTok{#> Mean Residual Deviance :  306}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.92 9.79 8.4 5.75 3.3 ...}
...
\CommentTok{#>   ..$ ME          : num -0.122}
\CommentTok{#>   ..$ MAE         : num 2.12}
\CommentTok{#>   ..$ RMSE        : num 3.62}
\CommentTok{#>   ..$ R.squared   : num 0.572}
\CommentTok{#>   ..$ logRMSE     : num 0.48}
\CommentTok{#>   ..$ logR.squared: num 0.657}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.90}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.71718333306229}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1278}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0881}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0832791630881815}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8260}
\CommentTok{#> SL.ksvm_All    0.1293 0.0219}
\CommentTok{#> SL.glmnet_All  0.3076 0.0000}
\CommentTok{#> SL.ranger_All  0.0860 0.1522}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> }
\CommentTok{#>                  Risk  Coef}
\CommentTok{#> SL.xgboost_All 0.0603 0.813}
\CommentTok{#> SL.ranger_All  0.0830 0.187}
\CommentTok{#> SL.ksvm_All    0.1317 0.000}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   Super Learner 0.16 0.014 0.095 0.25}
\CommentTok{#>     Discrete SL 0.17 0.014 0.114 0.25}
\CommentTok{#>  SL.xgboost_All 0.19 0.016 0.135 0.27}
\CommentTok{#>   SL.ranger_All 0.16 0.014 0.103 0.25}
\CommentTok{#>     SL.ksvm_All 0.18 0.014 0.110 0.30}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.165 0.472}
\CommentTok{#> SL.ksvm_All    0.163 0.528}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.66 4.75 4.9 4.87 4.8 ...}
...
\CommentTok{#> Growing trees.. Progress: 88%. Estimated remaining time: 4 seconds.}
\NormalTok{m.BLD_PTF}
\CommentTok{#> Ranger result}
\CommentTok{#> }
\CommentTok{#> Call:}
