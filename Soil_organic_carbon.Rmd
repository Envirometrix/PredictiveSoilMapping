...
knitr::include_graphics("figures/journal.pone.0105992.g005.png")
```
...
knitr::include_graphics("figures/usa48.ocd_10cm_year2014.png")
```

```{r usa48-ocd-1925, echo=FALSE, fig.cap="Predicted OCD (in kg/m$^3$) at 10 cm depth for the year 1925.", out.width="100%"}
knitr::include_graphics("figures/usa48.ocd_10cm_year1925.png")
```
