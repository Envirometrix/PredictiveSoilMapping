...
```{r psm-decision-tree, echo=FALSE, fig.cap="General decision tree in a Predictive Soil Mapping project.", out.width="95%"}
...
```{r psm-types-monitoring, echo=FALSE, fig.cap="Types of PSM projects depending on whether maps are generated for single usage, or for detecting change or soil monitoring.", out.width="65%"}
...
knitr::kable(
  ...
  caption = 'Example of a costs table for various quality levels PSM products. Prices expressed in US$ / Mpix (million of pixels produced).'
)
```
