...
```{r watersheds-by-flow-paths, echo=FALSE, fig.width=8, fig.cap="Watersheds by flow paths dervied using the [LITAP](https://steffilazerte.github.io/LITAP/) package."}
initial_dem <- readRDS(list.files("extdata/final", 
                            pattern = "dem_fill.rds", full.names = TRUE))
LITAP::flow_plot(db = initial_dem, type = "elevation", shed = TRUE, 
          shed_type = "fill", dir = TRUE)
```
