...
```{r scheme-soc-prof1, echo=FALSE, fig.cap="Determination of soil organic carbon density and stock for standard depth intervals: example of a mineral soil profile from Australia.", out.width="80%"}
...
```{r scheme-soc-prof2, echo=FALSE, fig.cap="Determination of soil organic carbon density and stock for standard depth intervals: example of an organic soil profile from Canada.", out.width="80%"}
...
```{r scheme-profiles-ocs, echo=FALSE, fig.cap="Estimation of OCS values 0–30 cm using some typical soil profile data without fitting splines.", out.width="90%"}
...
```{r soc-depth-plot, echo=FALSE, fig.cap="Globally fitted regression model for predicting soil organic carbon using depth only (log-log regression) and (a) individual soil profile from the ISRIC soil monolith collection. Image source: Hengl et al. (2014) doi: 10.1371/journal.pone.0105992.", out.width="90%"}
...
```{r ocs-three-approaches, echo=FALSE, fig.cap="Three main computational paths (2D and 3D) to producing maps of organic carbon stock.", out.width="90%"}
...
```{r libertad-soc, echo=FALSE, fig.cap="Example of a data set with OCS samples (for 2D prediction). Case study in Colombia available via the geospt package (https://cran.r-project.org/package=geospt).", out.width="65%"}
...
```{r plot-cosha30map-rf, echo=FALSE, fig.width=7, out.width="75%", fig.cap="Comparison of predictions generated using ordinary kriging (left) and machine learning with the help of 30 m resolution covariates and buffer distances (right)."}
...
```{r edgeroi-overview, echo=FALSE, fig.cap="Edgeroi data set: locations of soil profiles and Australian soil classification codes. For more details see Malone et al. (2009).", out.width="100%"}
...
```{r plot-edgeroi-ocd, echo=FALSE, fig.width=8, out.width="70%", fig.cap="Predicted organic carbon stock for 0–30 cm depth for the Edgeroi data set. All values expressed in tons/ha."}
...
spplot(edgeroi.grids["OCS.30cm.f"], main=paste0("Organic carbon stock 0", "\U2012", "30 cm (t/ha)"),
       col.regions=rev(viridis(20)), sp.layout = list(edgeroi.pts))
```

```{r plot-edgeroi-ocd-error, echo=FALSE, fig.width=8, out.width="70%", fig.cap="The prediction error map for the Edgeroi data set."}
spplot(edgeroi.grids["OCD.30cm_se"], main="Standard prediction error (t/ha)",
       col.regions=rev(bpy.colors(20)), sp.layout = list(edgeroi.pts))
```
...
```{r thist-usa48, fig.width=5.5, out.width="75%", fig.cap="Distribution of soil observations based on sampling year."}
...
```{r usa48-ocd-2014, echo=FALSE, fig.cap="Predicted OCD (in kg/cubic-m) at 10 cm depth for the year 2014. Blue colors indicate low values, red high values.", out.width="90%"}
knitr::include_graphics("figures/usa48_ocd_10cm_year2014.png")
```

```{r usa48-ocd-1925, echo=FALSE, fig.cap="Predicted OCD (in kg/cubic-m) at 10 cm depth for the year 1925.", out.width="90%"}
