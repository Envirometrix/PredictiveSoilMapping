...
```{r plot-edgeroi-ocd, echo=FALSE, fig.width=9, out.width="90%", fig.cap="Predicted organic carbon stock for 0–30 cm depth and error map for the Edgeroi data set. All values expressed in tons/ha."}
library(raster)
...
```{r thist-usa48, fig.width=5.5, out.width="85%", fig.cap="Distribution of soil observations based on sampling year."}
