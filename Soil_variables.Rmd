...
```{r scheme-solum, echo=FALSE, fig.cap="Standard soil horizons, solum thickness and depth to bedrock (left), six standard depths used in the *GlobalSoilMap* project (right).", out.width="45%", out.extra="angle=270"}
...
```{r lri-scheme, echo=FALSE, fig.cap="Derivation of the Limiting Rooting Index: (left) soil pH values and corresponding LRI, (right) coarse fragments and corresponding LRI [@Leenaars2018].", out.width="40%", out.extra="angle=270"}
...
```{r usda-categories, echo=FALSE, fig.cap="USDA classification system and approximate minimum required number of observations to fit a global multinomial regression model.", out.width="60%", out.extra="angle=270"}
...
```{r plot-tt-triangle, fig.height=8, fig.width=8, out.width = '50%', fig.cap="Soil texture triangle based on the USDA system. Generated using the [soiltexture package](http://cran.r-project.org/web/packages/soiltexture/) in R."}
library(soiltexture)
...
```{r plot-tt-afsis, fig.height=8, fig.width=8, out.width = '50%', fig.cap="Distribution of observed soil textures for the [Africa Soil Profiles](http://gsif.r-forge.r-project.org/afsp.html)."}
