...
```{r plot-tt-triangle, fig.width=10, dpi=300, fig.cap="Soil texture triangle based on the USDA system. Generated using the soiltexture package (http://cran.r-project.org/web/packages/soiltexture/)."}
library(soiltexture)
