...
```{r plot-tt-triangle, dpi=300, fig.cap="Soil texture triangle based on the USDA system. Generated using the [soiltexture package](http://cran.r-project.org/web/packages/soiltexture/) in R."}
library(soiltexture)
