...
#> Model ID:  DRF_model_R_1545333351356_21 
#> Model Summary: 
#>   number_of_trees number_of_internal_trees model_size_in_bytes min_depth
#> 1              50                       50              648189        20
#>   max_depth mean_depth min_leaves max_leaves mean_leaves
#> 1        20   20.00000        956       1084  1028.16000
#> 
#> 
...
#> Model ID:  DeepLearning_model_R_1545333351356_22 
...
#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.014746 0.007834
#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.125207 0.176683
#> 4     4     1    Linear      NA 0.000000 0.000000  0.001309 0.000991
#>   momentum mean_weight weight_rms mean_bias bias_rms
#> 1       NA          NA         NA        NA       NA
#> 2 0.000000   -0.000415   0.101695  0.368019 0.057855
#> 3 0.000000   -0.017868   0.071222  0.957864 0.016090
#> 4 0.000000    0.002121   0.051710  0.109518 0.000000
#> 
#> 
...
#>   ..$ Predicted: num [1:4972] 11.55 7.44 6.59 4.97 3.43 ...
...
#> Family: gaussian
#> 
#> Ensemble performance (MSE): 12.2172032144361
```
...
#> 4 h2o.deeplearning.wrapper 0.1444
...
#> Family: gaussian
#> 
#> Ensemble performance (MSE): 0.080263443448992
```
...
#>     SL.ksvm_All 0.18 0.015 0.108 0.31
```
...
#> SL.ranger_All  0.166 0.458
#> SL.ksvm_All    0.162 0.542
...
str(pred.PHI[[1]])
#> List of 2
#>  $ pred           : num [1:3865, 1] 4.66 4.73 4.88 4.85 4.78 ...
