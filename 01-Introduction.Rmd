...
```{r lagacherie1992, echo=FALSE, fig.cap="Reduction of prediction error as a function of sampling intensity (for three control areas). Based on Lagacherie (1992).", out.width="70%", out.extra="angle=0"}
...
```{r sigma-rmse-relationship, echo=FALSE, fig.cap="Relationship between the numeric resolution (visualized using a histogram plot on the left) and amount of variation explained by the model for soil pH.", out.width="90%"}
