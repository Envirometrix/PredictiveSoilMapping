...
```{r obs-pred-snd, echo=FALSE, fig.cap="Measured vs predicted SAND content based on the Random Forest model.", out.width="70%"}
...
```{r plot-measured-predicted, echo=FALSE, fig.cap="Predicted vs observed plot for soil organic carbon ML-based model (Edgeroi data set).", out.width="70%"}
...
```{r rf-variableImportance, fig.width=5, fig.cap="Variable importance plot for mapping zinc content based on the Meuse data set."}
