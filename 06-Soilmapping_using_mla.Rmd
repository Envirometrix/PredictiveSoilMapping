...
```{r maps-soc-edgeroi, echo=FALSE, fig.width=8, out.width="90%", fig.cap="Comparison of three MLA's and final ensemble prediction (ORCDRC 5cm) of soil organic carbon content for 2.5 cm depth."}
