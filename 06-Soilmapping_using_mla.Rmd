...
```{r obs-pred-snd, echo=FALSE, fig.cap="Measured vs predicted sand content based on the Random Forest model.", out.width="55%"}
...
```{r maps-soc-edgeroi, echo=FALSE, fig.width=7, out.width="80%", fig.cap="Comparison of three MLA's and final ensemble prediction (ORCDRC 5cm) of soil organic carbon content for 2.5 cm depth."}
...
```{r plot-measured-predicted, echo=FALSE, fig.cap="Predicted vs observed plot for soil organic carbon ML-based model (Edgeroi data set).", out.width="55%"}
...
```{r rf-variableImportance, fig.width=5, out.width="80%", fig.cap="Variable importance plot for mapping zinc content based on the Meuse data set."}
