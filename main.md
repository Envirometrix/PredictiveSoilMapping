...
#>     H2O cluster uptime:         23 minutes 28 seconds 
...
#> Model ID:  DRF_model_R_1550180395669_21 
#> Model Summary: 
#>   number_of_trees number_of_internal_trees model_size_in_bytes min_depth
#> 1              50                       50              644346        20
#>   max_depth mean_depth min_leaves max_leaves mean_leaves
#> 1        20   20.00000        946       1066  1022.14000
#> 
#> 
...
#> Model ID:  DeepLearning_model_R_1550180395669_22 
...
#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.015457 0.009568
#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.125230 0.181684
#> 4     4     1    Linear      NA 0.000000 0.000000  0.001192 0.000810
#>   momentum mean_weight weight_rms mean_bias bias_rms
#> 1       NA          NA         NA        NA       NA
#> 2 0.000000    0.000907   0.102123  0.364073 0.060487
#> 3 0.000000   -0.017717   0.071025  0.957393 0.015820
#> 4 0.000000    0.010424   0.048302  0.114905 0.000000
#> 
#> 
...
#>   ..$ Predicted: num [1:4972] 12.64 7.28 7.04 5.19 3.19 ...
...
#> Family: gaussian
#> 
#> Ensemble performance (MSE): 12.746156091879
```
...
#> 4 h2o.deeplearning.wrapper 0.1405
...
#> Family: gaussian
#> 
#> Ensemble performance (MSE): 0.0756085031793977
```
...
#> SL.xgboost_All 0.0598 0.81372
#> SL.ksvm_All    0.1301 0.00688
#> SL.glmnet_All  0.3079 0.00000
#> SL.ranger_All  0.0852 0.17941
```
...
#> 
#>                  Risk Coef
#> SL.xgboost_All 0.0603 0.82
#> SL.ranger_All  0.0839 0.18
#> SL.ksvm_All    0.1304 0.00
```
...
#>     Discrete SL 0.16 0.014 0.103 0.25
...
#> SL.ranger_All  0.164 0.489
#> SL.ksvm_All    0.163 0.511
...
str(pred.PHI[[1]])
#> List of 2
#>  $ pred           : num [1:3865, 1] 4.69 4.77 4.89 4.85 4.78 ...
