...
\CommentTok{#> R 2018-12-20 18:58:33 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 160.989398213345"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x1314a490> }
...
\CommentTok{#>     /tmp/Rtmpx2sbH2/h2o_travis_started_from_r.out}
\CommentTok{#>     /tmp/Rtmpx2sbH2/h2o_travis_started_from_r.err}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> Starting H2O JVM and connecting: .. Connection successful!}
\CommentTok{#> }
\CommentTok{#> R is connected to the H2O cluster: }
\CommentTok{#>     H2O cluster uptime:         1 seconds 984 milliseconds }
...
\CommentTok{#> }
\CommentTok{#> MSE:  214}
\CommentTok{#> RMSE:  14.6}
\CommentTok{#> MAE:  9.98}
\CommentTok{#> RMSLE:  0.427}
\CommentTok{#> Mean Residual Deviance :  214}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545332371665_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.014989 0.010740}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.159316 0.196309}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001466 0.001011}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.001717   0.101552  0.319937 0.076060}
\CommentTok{#> 3 0.000000   -0.019978   0.071837  0.943611 0.026007}
\CommentTok{#> 4 0.000000    0.002086   0.046041  0.119232 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> }
\CommentTok{#> MSE:  317}
\CommentTok{#> RMSE:  17.8}
\CommentTok{#> MAE:  14.1}
\CommentTok{#> RMSLE:  0.555}
\CommentTok{#> Mean Residual Deviance :  317}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.59 11.43 9.79 6.04 3.35 ...}
...
\CommentTok{#>   ..$ logR.squared: num 0.653}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.73}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.59479784679564}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1722}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0783}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0735084661076653}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8108}
\CommentTok{#> SL.ksvm_All    0.1283 0.0116}
\CommentTok{#> SL.glmnet_All  0.3076 0.0000}
\CommentTok{#> SL.ranger_All  0.0848 0.1776}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> }
\CommentTok{#>                  Risk  Coef}
\CommentTok{#> SL.xgboost_All 0.0603 0.806}
\CommentTok{#> SL.ranger_All  0.0826 0.194}
\CommentTok{#> SL.ksvm_All    0.1313 0.000}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>     Discrete SL 0.17 0.014 0.112 0.25}
...
\CommentTok{#> SL.ranger_All  0.166 0.473}
\CommentTok{#> SL.ksvm_All    0.163 0.527}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.72 4.8 4.94 4.91 4.83 ...}
