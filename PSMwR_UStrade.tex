...
\CommentTok{#> R 2018-12-27 05:40:54 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 158.668714052368"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x14926670> }
...
\CommentTok{#>     /tmp/RtmpgoYlXf/h2o_travis_started_from_r.out}
\CommentTok{#>     /tmp/RtmpgoYlXf/h2o_travis_started_from_r.err}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> Starting H2O JVM and connecting: .. Connection successful!}
\CommentTok{#> }
\CommentTok{#> R is connected to the H2O cluster: }
\CommentTok{#>     H2O cluster uptime:         2 seconds 128 milliseconds }
...
\CommentTok{#> Mean Residual Deviance :  224}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545889312513_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.014505 0.009251}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.143811 0.179499}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001438 0.001292}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.001433   0.101402  0.348474 0.061411}
\CommentTok{#> 3 0.000000   -0.018650   0.071385  0.949960 0.022889}
\CommentTok{#> 4 0.000000   -0.002978   0.044547  0.098333 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> MAE:  13.9}
\CommentTok{#> RMSLE:  0.548}
\CommentTok{#> Mean Residual Deviance :  305}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 13.53 9.66 8.88 6.61 3.56 ...}
...
\CommentTok{#>   ..$ ME          : num -0.106}
\CommentTok{#>   ..$ MAE         : num 2.1}
\CommentTok{#>   ..$ RMSE        : num 3.59}
\CommentTok{#>   ..$ R.squared   : num 0.578}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.49378419358704}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1638}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0791961758225583}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.80563}
\CommentTok{#> SL.ksvm_All    0.1289 0.00359}
\CommentTok{#> SL.glmnet_All  0.3081 0.00000}
\CommentTok{#> SL.ranger_All  0.0843 0.19078}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.0825 0.194}
\CommentTok{#> SL.ksvm_All    0.1316 0.000}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>     Discrete SL 0.17 0.014 0.113 0.24}
\CommentTok{#>  SL.xgboost_All 0.19 0.016 0.135 0.27}
\CommentTok{#>   SL.ranger_All 0.16 0.014 0.101 0.24}
...
\CommentTok{#> SL.ranger_All  0.165 0.47}
\CommentTok{#> SL.ksvm_All    0.162 0.53}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.69 4.77 4.9 4.86 4.8 ...}
