...
\CommentTok{#> R 2018-12-29 03:23:07 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 160.799286958176"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x13fad978> }
...
\CommentTok{#>     /tmp/RtmpsRZkVD/h2o_travis_started_from_r.out}
\CommentTok{#>     /tmp/RtmpsRZkVD/h2o_travis_started_from_r.err}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> Starting H2O JVM and connecting: .. Connection successful!}
\CommentTok{#> }
\CommentTok{#> R is connected to the H2O cluster: }
\CommentTok{#>     H2O cluster uptime:         2 seconds 88 milliseconds }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1546053844257_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.013774 0.007808}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.131760 0.182943}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001421 0.000938}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.005832   0.099307  0.328378 0.075885}
\CommentTok{#> 3 0.000000   -0.018645   0.070921  0.949578 0.023323}
\CommentTok{#> 4 0.000000    0.006713   0.050796  0.105456 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> }
\CommentTok{#> MSE:  298}
\CommentTok{#> RMSE:  17.3}
\CommentTok{#> MAE:  13.4}
\CommentTok{#> RMSLE:  0.536}
\CommentTok{#> Mean Residual Deviance :  298}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.82 10.96 8.96 5.89 3.52 ...}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.39}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.31742292350353}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1566}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0802}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.073559326962404}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8133}
\CommentTok{#> SL.ksvm_All    0.1282 0.0133}
\CommentTok{#> SL.glmnet_All  0.3080 0.0000}
\CommentTok{#> SL.ranger_All  0.0852 0.1734}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.0831 0.188}
...
\CommentTok{#> SL.ranger_All  0.165 0.473}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.68 4.76 4.9 4.85 4.79 ...}
