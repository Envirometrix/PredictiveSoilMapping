...
\CommentTok{#> R 2018-12-20 18:03:05 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 162.074082927079"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x130f2fc8> }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545329043122_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.015044 0.009814}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.124171 0.163956}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001483 0.001592}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.003985   0.101811  0.342623 0.068881}
\CommentTok{#> 3 0.000000   -0.018950   0.071449  0.950454 0.020509}
\CommentTok{#> 4 0.000000   -0.000695   0.046861  0.090752 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 15.17 11.08 9.81 5.98 3.42 ...}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.55}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.59753035151181}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1349}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0804202108230024}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.81576}
\CommentTok{#> SL.ksvm_All    0.1301 0.00946}
\CommentTok{#> SL.glmnet_All  0.3085 0.00000}
\CommentTok{#> SL.ranger_All  0.0853 0.17478}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> }
\CommentTok{#>                  Risk  Coef}
\CommentTok{#> SL.xgboost_All 0.0603 0.805}
\CommentTok{#> SL.ranger_All  0.0825 0.195}
\CommentTok{#> SL.ksvm_All    0.1310 0.000}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   SL.ranger_All 0.16 0.015 0.101 0.25}
...
\CommentTok{#> SL.ranger_All  0.164 0.495}
\CommentTok{#> SL.ksvm_All    0.164 0.505}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.63 4.69 4.82 4.82 4.74 ...}
