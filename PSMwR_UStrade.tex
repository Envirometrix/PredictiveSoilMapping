...
\CommentTok{#> R 2018-12-20 20:45:45 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 161.64343745606"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x13cb4340> }
...
\CommentTok{#>     /tmp/RtmpNVp1JG/h2o_travis_started_from_r.out}
\CommentTok{#>     /tmp/RtmpNVp1JG/h2o_travis_started_from_r.err}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> Starting H2O JVM and connecting: .. Connection successful!}
\CommentTok{#> }
\CommentTok{#> R is connected to the H2O cluster: }
\CommentTok{#>     H2O cluster uptime:         2 seconds 71 milliseconds }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545338803760_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.014926 0.009688}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.120280 0.156933}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001308 0.000815}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.003638   0.101017  0.351412 0.072436}
\CommentTok{#> 3 0.000000   -0.018291   0.071261  0.954765 0.022489}
\CommentTok{#> 4 0.000000    0.001748   0.048216  0.091960 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 15.16 10.5 9.37 6.32 3.44 ...}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.32}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.21578833350367}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1493}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0813}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0759450177387433}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.81162}
\CommentTok{#> SL.ksvm_All    0.1300 0.00745}
\CommentTok{#> SL.glmnet_All  0.3079 0.00000}
\CommentTok{#> SL.ranger_All  0.0851 0.18092}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   SL.ranger_All 0.17 0.015 0.103 0.25}
\CommentTok{#>     SL.ksvm_All 0.18 0.014 0.108 0.29}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.165 0.479}
\CommentTok{#> SL.ksvm_All    0.163 0.521}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.71 4.79 4.91 4.89 4.82 ...}
