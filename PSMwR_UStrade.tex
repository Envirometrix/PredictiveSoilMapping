...
\CommentTok{#> R 2018-12-28 03:42:54 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 162.603093046564"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x133d0fb0> }
...
\CommentTok{#>     /tmp/Rtmp0a4qsA/h2o_travis_started_from_r.out}
\CommentTok{#>     /tmp/Rtmp0a4qsA/h2o_travis_started_from_r.err}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> Starting H2O JVM and connecting: .. Connection successful!}
\CommentTok{#> }
\CommentTok{#> R is connected to the H2O cluster: }
\CommentTok{#>     H2O cluster uptime:         2 seconds 116 milliseconds }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545968633691_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.014286 0.009332}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.159409 0.206444}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001430 0.000983}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.002113   0.099758  0.316398 0.083582}
\CommentTok{#> 3 0.000000   -0.019796   0.071381  0.945527 0.024073}
\CommentTok{#> 4 0.000000    0.004180   0.046957  0.121665 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> }
\CommentTok{#> MSE:  294}
\CommentTok{#> RMSE:  17.1}
\CommentTok{#> MAE:  13.8}
\CommentTok{#> RMSLE:  0.545}
\CommentTok{#> Mean Residual Deviance :  294}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.21 10.53 8.63 5.3 3.34 ...}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.5302018474032}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1401}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0854}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0805661828250735}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.822}
\CommentTok{#> SL.ksvm_All    0.1293 0.018}
\CommentTok{#> SL.glmnet_All  0.3072 0.000}
\CommentTok{#> SL.ranger_All  0.0855 0.160}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.0830 0.192}
...
\CommentTok{#> SL.ranger_All  0.164 0.482}
\CommentTok{#> SL.ksvm_All    0.163 0.518}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.65 4.71 4.85 4.85 4.75 ...}
