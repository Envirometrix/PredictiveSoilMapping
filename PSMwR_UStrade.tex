...
\CommentTok{#> R 2018-12-20 18:00:42 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 161.0778630445"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x1400b2f0> }
...
\CommentTok{#>     H2O cluster uptime:         10 minutes 37 seconds }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545328262795_12 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.014300 0.009383}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.129402 0.186481}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001385 0.001094}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.004568   0.102147  0.357288 0.068182}
\CommentTok{#> 3 0.000000   -0.018549   0.070815  0.955038 0.021354}
\CommentTok{#> 4 0.000000   -0.000921   0.050226  0.122908 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> }
\CommentTok{#> MSE:  283}
\CommentTok{#> RMSE:  16.8}
\CommentTok{#> MAE:  13.2}
\CommentTok{#> RMSLE:  0.527}
\CommentTok{#> Mean Residual Deviance :  283}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 12.56 7.73 6.52 5.07 2.9 ...}
...
\CommentTok{#>   ..$ ME          : num -0.13}
\CommentTok{#>   ..$ MAE         : num 2.18}
\CommentTok{#>   ..$ RMSE        : num 3.68}
\CommentTok{#>   ..$ R.squared   : num 0.557}
\CommentTok{#>   ..$ logRMSE     : num 0.496}
\CommentTok{#>   ..$ logR.squared: num 0.633}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 12.7}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 12.3014640677509}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1490}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0771518698511041}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8216}
\CommentTok{#> SL.ksvm_All    0.1285 0.0182}
\CommentTok{#> SL.glmnet_All  0.3078 0.0000}
\CommentTok{#> SL.ranger_All  0.0860 0.1602}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.0832 0.188}
...
\CommentTok{#>     Discrete SL 0.17 0.014 0.113 0.25}
\CommentTok{#>  SL.xgboost_All 0.19 0.016 0.135 0.27}
\CommentTok{#>   SL.ranger_All 0.16 0.014 0.101 0.25}
...
\CommentTok{#> SL.ranger_All  0.166 0.477}
\CommentTok{#> SL.ksvm_All    0.164 0.523}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.66 4.73 4.88 4.86 4.77 ...}
