...
\CommentTok{#> R 2019-01-26 15:44:23 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 154.408096799276"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x156b20c0> }
...
\CommentTok{#>     /tmp/RtmpnEZ9Jl/h2o_travis_started_from_r.out}
\CommentTok{#>     /tmp/RtmpnEZ9Jl/h2o_travis_started_from_r.err}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> Starting H2O JVM and connecting: .. Connection successful!}
\CommentTok{#> }
\CommentTok{#> R is connected to the H2O cluster: }
\CommentTok{#>     H2O cluster uptime:         2 seconds 306 milliseconds }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1548517525068_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.015463 0.009221}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.147285 0.191379}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001302 0.000864}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000   -0.000901   0.101474  0.358830 0.066378}
\CommentTok{#> 3 0.000000   -0.018252   0.071309  0.955076 0.017804}
\CommentTok{#> 4 0.000000   -0.002197   0.048331  0.122767 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Mean Residual Deviance :  258}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.23 10.09 9.45 5.98 3.45 ...}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.64}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.42578642775103}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1334}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0832}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0801016484930874}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.823}
\CommentTok{#> SL.ksvm_All    0.1283 0.022}
\CommentTok{#> SL.glmnet_All  0.3072 0.000}
\CommentTok{#> SL.ranger_All  0.0860 0.155}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> }
\CommentTok{#>                  Risk  Coef}
\CommentTok{#> SL.xgboost_All 0.0603 0.825}
\CommentTok{#> SL.ranger_All  0.0842 0.175}
\CommentTok{#> SL.ksvm_All    0.1305 0.000}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>     Discrete SL 0.17 0.015 0.116 0.25}
...
\CommentTok{#> SL.ranger_All  0.166 0.461}
\CommentTok{#> SL.ksvm_All    0.162 0.539}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.68 4.76 4.9 4.86 4.79 ...}
...
\CommentTok{#> Growing trees.. Progress: 73%. Estimated remaining time: 11 seconds.}
\NormalTok{m.BLD_PTF}
\CommentTok{#> Ranger result}
\CommentTok{#> }
\CommentTok{#> Call:}
