...
\CommentTok{#> R 2018-12-29 11:48:32 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 160.01169603473"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x13704440> }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1546084173663_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.014900 0.009994}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.132766 0.176822}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001336 0.000918}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.004419   0.101751  0.356321 0.066362}
\CommentTok{#> 3 0.000000   -0.018289   0.071035  0.954532 0.022856}
\CommentTok{#> 4 0.000000   -0.001867   0.051163  0.101003 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> MAE:  12.7}
\CommentTok{#> RMSLE:  0.515}
\CommentTok{#> Mean Residual Deviance :  280}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.06 11.29 9.32 5.55 3.66 ...}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.04}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.06390951923356}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.2267}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0839}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0799131561700886}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8109}
\CommentTok{#> SL.ksvm_All    0.1289 0.0063}
\CommentTok{#> SL.glmnet_All  0.3080 0.0000}
\CommentTok{#> SL.ranger_All  0.0850 0.1828}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.0835 0.181}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.66 4.73 4.85 4.82 4.76 ...}
...
e.g.~field, lab, data entry). Persistent and unique machie readable identifiers can help to
...
on reproducibility and accuracy \citep{shepherd2007infrared}. A modern soil laboratory now entails
...
US\$ 2-10 per profile \citep{shepherd2007infrared}.
