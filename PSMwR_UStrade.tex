...
\CommentTok{#> R 2018-12-21 19:05:40 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 160.147469107213"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x13eb8b38> }
...
\CommentTok{#> }
\CommentTok{#> MSE:  217}
\CommentTok{#> RMSE:  14.7}
\CommentTok{#> MAE:  9.95}
\CommentTok{#> RMSLE:  0.427}
\CommentTok{#> Mean Residual Deviance :  217}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545419199026_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.015384 0.009246}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.118860 0.160878}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001203 0.000749}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.007880   0.102251  0.385787 0.056809}
\CommentTok{#> 3 0.000000   -0.016961   0.071107  0.960016 0.015992}
\CommentTok{#> 4 0.000000    0.000450   0.047679  0.121743 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> }
\CommentTok{#> MSE:  250}
\CommentTok{#> RMSE:  15.8}
\CommentTok{#> MAE:  11.8}
\CommentTok{#> RMSLE:  0.483}
\CommentTok{#> Mean Residual Deviance :  250}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 15.44 10.9 8.52 6.04 3.8 ...}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.42}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.28137060499616}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1979}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0812352132801149}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ksvm_All    0.1288 0.0126}
\CommentTok{#> SL.glmnet_All  0.3081 0.0000}
\CommentTok{#> SL.ranger_All  0.0853 0.1708}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>     SL.ksvm_All 0.18 0.015 0.109 0.31}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.64 4.71 4.86 4.83 4.75 ...}
