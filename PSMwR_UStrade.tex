...
\usepackage[top=1.6cm, bottom=2cm, left=1cm, right=1cm]{geometry}
\usepackage{color}
\usepackage{fancyvrb}
\newcommand{\VerbBar}{|}
...
\tightlist
\item
  Hengl, T., MacMillan, R.A., (2019). \textbf{Predictive Soil Mapping with R}. OpenGeoHub foundation, Wageningen, the Netherlands, 420 pages. ISBN: 978-0-359-30635-0.
\end{itemize}
...
\CommentTok{#> R 2019-01-04 13:36:16 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 158.973269248708"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x13ad7f28> }
...
\CommentTok{#> Your H2O cluster version is too old (3 months and 13 days)!}
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1546609035994_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.014943 0.008857}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.137426 0.189062}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001312 0.000947}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000   -0.003222   0.104844  0.365428 0.066160}
\CommentTok{#> 3 0.000000   -0.017074   0.071406  0.958022 0.018498}
\CommentTok{#> 4 0.000000    0.000999   0.049347  0.108892 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> }
\CommentTok{#> MSE:  274}
\CommentTok{#> RMSE:  16.5}
\CommentTok{#> MAE:  12.5}
\CommentTok{#> RMSLE:  0.51}
\CommentTok{#> Mean Residual Deviance :  274}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.47 10.29 9.22 5.86 3.83 ...}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.58}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.42302683423622}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1704}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0793469749094449}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8267}
\CommentTok{#> SL.ksvm_All    0.1298 0.0181}
\CommentTok{#> SL.glmnet_All  0.3076 0.0000}
\CommentTok{#> SL.ranger_All  0.0863 0.1551}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.0827 0.19}
\CommentTok{#> SL.ksvm_All    0.1307 0.00}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>     Discrete SL 0.17 0.015 0.113 0.25}
\CommentTok{#>  SL.xgboost_All 0.19 0.016 0.135 0.27}
\CommentTok{#>   SL.ranger_All 0.16 0.015 0.104 0.25}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.72 4.79 4.94 4.88 4.82 ...}
...
\CommentTok{#> Growing trees.. Progress: 87%. Estimated remaining time: 4 seconds.}
\NormalTok{m.BLD_PTF}
\CommentTok{#> Ranger result}
\CommentTok{#> }
\CommentTok{#> Call:}
...
on reproducibility and accuracy \citep{ShepherdWalsh2007JNIS}. A modern soil laboratory now entails
...
US\$ 2--10 per profile \citep{ShepherdWalsh2007JNIS}.
...
spectroscopy \citep{wilford1997application, viscarra2007multivariate}. This sensor can provide very direct and interpretable
...
process scales and formative influences \citep{Behrens2018EJSS}.
