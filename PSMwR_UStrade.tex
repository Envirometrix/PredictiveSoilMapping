...
\CommentTok{#> R 2018-12-29 00:11:13 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 158.4129224129"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x13f28aa0> }
...
\CommentTok{#>     /tmp/Rtmp31KAPr/h2o_travis_started_from_r.out}
\CommentTok{#>     /tmp/Rtmp31KAPr/h2o_travis_started_from_r.err}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> Starting H2O JVM and connecting: .. Connection successful!}
\CommentTok{#> }
\CommentTok{#> R is connected to the H2O cluster: }
\CommentTok{#>     H2O cluster uptime:         2 seconds 86 milliseconds }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1546042331228_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.015116 0.008983}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.116775 0.148167}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001951 0.008429}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.003011   0.102790  0.355448 0.061966}
\CommentTok{#> 3 0.000000   -0.018501   0.071226  0.953281 0.018698}
\CommentTok{#> 4 0.000000    0.004306   0.050575  0.096160 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> MAE:  12.5}
\CommentTok{#> RMSLE:  0.504}
\CommentTok{#> Mean Residual Deviance :  266}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 15.28 10.14 8.28 5.72 3.6 ...}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.75}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.77989287492254}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1448}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0874}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0831413932857379}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8194}
\CommentTok{#> SL.ksvm_All    0.1292 0.0171}
\CommentTok{#> SL.glmnet_All  0.3076 0.0000}
\CommentTok{#> SL.ranger_All  0.0859 0.1635}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   Super Learner 0.16 0.014 0.092 0.26}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.66 4.73 4.88 4.85 4.78 ...}
