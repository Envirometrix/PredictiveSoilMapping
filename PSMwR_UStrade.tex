...
\CommentTok{#> R 2018-12-28 07:52:46 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 161.901815169042"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x1309ff90> }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545983626006_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.016367 0.010294}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.142045 0.192633}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001317 0.000921}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.003485   0.097063  0.333310 0.082208}
\CommentTok{#> 3 0.000000   -0.018796   0.070883  0.952706 0.016776}
\CommentTok{#> 4 0.000000    0.009969   0.050445  0.089195 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Mean Residual Deviance :  262}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.95 10.62 9.68 5.38 3.26 ...}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.33}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.20200264891668}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1655}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0780}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0754178109250091}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.80989}
\CommentTok{#> SL.ksvm_All    0.1291 0.00549}
\CommentTok{#> SL.glmnet_All  0.3072 0.00000}
\CommentTok{#> SL.ranger_All  0.0846 0.18462}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> }
\CommentTok{#>                  Risk  Coef}
\CommentTok{#> SL.xgboost_All 0.0603 0.797}
\CommentTok{#> SL.ranger_All  0.0821 0.203}
...
\CommentTok{#>     Discrete SL 0.17 0.015 0.119 0.25}
...
\CommentTok{#> SL.ranger_All  0.166 0.471}
\CommentTok{#> SL.ksvm_All    0.163 0.529}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.66 4.74 4.88 4.84 4.78 ...}
