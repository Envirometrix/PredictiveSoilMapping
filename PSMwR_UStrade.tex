...
\CommentTok{#> R 2018-12-26 06:41:46 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 163.270098928935"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x12e0a610> }
...
\CommentTok{#>     /tmp/Rtmp85ocDx/h2o_travis_started_from_r.out}
\CommentTok{#>     /tmp/Rtmp85ocDx/h2o_travis_started_from_r.err}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545806566630_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.016033 0.010329}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.163616 0.201388}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001357 0.000832}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.000378   0.103147  0.359565 0.069835}
\CommentTok{#> 3 0.000000   -0.018187   0.071170  0.954236 0.018902}
\CommentTok{#> 4 0.000000    0.001496   0.044875  0.077467 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Mean Residual Deviance :  286}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.24 10.85 9.39 5.99 3.26 ...}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.72}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.66003073403914}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1286}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0819}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.079034575671638}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.81125}
\CommentTok{#> SL.ksvm_All    0.1292 0.00754}
\CommentTok{#> SL.glmnet_All  0.3077 0.00000}
\CommentTok{#> SL.ranger_All  0.0849 0.18121}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.0833 0.186}
...
\CommentTok{#> SL.ranger_All  0.165 0.485}
\CommentTok{#> SL.ksvm_All    0.163 0.515}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.66 4.73 4.85 4.85 4.77 ...}
