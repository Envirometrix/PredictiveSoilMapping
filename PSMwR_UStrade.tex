...
\CommentTok{#> R 2018-12-20 15:26:55 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 160.054373439024"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x13254c18> }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545318931874_12 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.016674 0.010502}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.131172 0.173739}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001274 0.000933}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.004994   0.101708  0.357650 0.062087}
\CommentTok{#> 3 0.000000   -0.018368   0.070917  0.952397 0.018830}
\CommentTok{#> 4 0.000000    0.004734   0.046630  0.079664 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 12.13 7.06 6.6 4.77 3.06 ...}
...
\CommentTok{#>   ..$ R.squared   : num 0.556}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 12.334380214378}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8179}
\CommentTok{#> SL.ksvm_All    0.1294 0.0135}
\CommentTok{#> SL.glmnet_All  0.3080 0.0000}
\CommentTok{#> SL.ranger_All  0.0853 0.1686}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.165 0.48}
\CommentTok{#> SL.ksvm_All    0.163 0.52}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.65 4.73 4.84 4.8 4.73 ...}
...
\CommentTok{#> Growing trees.. Progress: 48%. Estimated remaining time: 33 seconds.}
\CommentTok{#> Growing trees.. Progress: 96%. Estimated remaining time: 2 seconds.}
\NormalTok{m.BLD_PTF}
\CommentTok{#> Ranger result}
\CommentTok{#> }
\CommentTok{#> Call:}
