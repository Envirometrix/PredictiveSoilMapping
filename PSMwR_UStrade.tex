...
\CommentTok{#> R 2018-12-20 15:18:49 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 160.802383471875"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x1421ef88> }
...
\CommentTok{#>     H2O cluster uptime:         10 minutes 21 seconds }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545318565157_12 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.015749 0.009533}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.156254 0.195033}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001455 0.001012}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.003098   0.103152  0.346525 0.063914}
\CommentTok{#> 3 0.000000   -0.018620   0.071029  0.952082 0.020378}
\CommentTok{#> 4 0.000000   -0.000925   0.044842  0.083074 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> }
\CommentTok{#> MSE:  247}
\CommentTok{#> RMSE:  15.7}
\CommentTok{#> MAE:  11.7}
\CommentTok{#> RMSLE:  0.481}
\CommentTok{#> Mean Residual Deviance :  247}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 11.55 7.39 6.45 4.68 2.97 ...}
...
\CommentTok{#>   ..$ ME          : num -0.118}
\CommentTok{#>   ..$ MAE         : num 2.18}
\CommentTok{#>   ..$ RMSE        : num 3.67}
\CommentTok{#>   ..$ R.squared   : num 0.559}
\CommentTok{#>   ..$ logRMSE     : num 0.493}
\CommentTok{#>   ..$ logR.squared: num 0.637}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 13.0}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 12.4309943006841}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1299}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0768735839013094}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.81385}
\CommentTok{#> SL.ksvm_All    0.1298 0.00818}
\CommentTok{#> SL.glmnet_All  0.3074 0.00000}
\CommentTok{#> SL.ranger_All  0.0851 0.17797}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ksvm_All    0.1311 0.00}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   Super Learner 0.16 0.014 0.093 0.26}
\CommentTok{#>     Discrete SL 0.17 0.015 0.112 0.25}
\CommentTok{#>  SL.xgboost_All 0.19 0.016 0.135 0.27}
\CommentTok{#>   SL.ranger_All 0.17 0.015 0.102 0.25}
...
\CommentTok{#> SL.ranger_All  0.165 0.478}
\CommentTok{#> SL.ksvm_All    0.163 0.522}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.69 4.76 4.9 4.86 4.79 ...}
