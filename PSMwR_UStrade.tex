...
\CommentTok{#> R 2018-12-22 21:54:55 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 161.839653267375"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x12f29458> }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545515754923_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.015196 0.008750}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.111032 0.147210}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001225 0.000765}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.001263   0.100883  0.354908 0.073286}
\CommentTok{#> 3 0.000000   -0.018393   0.071072  0.954592 0.019078}
\CommentTok{#> 4 0.000000    0.002260   0.048633  0.094136 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> MAE:  12.6}
\CommentTok{#> RMSLE:  0.507}
\CommentTok{#> Mean Residual Deviance :  271}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 13.37 9.87 8.69 6.24 3.9 ...}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.46}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.3856359778443}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1373}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0794332612812911}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8212}
\CommentTok{#> SL.ksvm_All    0.1285 0.0177}
\CommentTok{#> SL.glmnet_All  0.3081 0.0000}
\CommentTok{#> SL.ranger_All  0.0854 0.1611}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.0827 0.194}
\CommentTok{#> SL.ksvm_All    0.1290 0.000}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.68 4.74 4.88 4.85 4.78 ...}
