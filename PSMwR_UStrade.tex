...
\CommentTok{#> R 2018-12-20 14:01:41 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 160.54567308853"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x145b8848> }
...
\CommentTok{#>     H2O cluster uptime:         10 minutes 24 seconds }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545313935626_12 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.015413 0.009751}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.119033 0.162360}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001318 0.001058}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.003201   0.100586  0.350921 0.066688}
\CommentTok{#> 3 0.000000   -0.018297   0.071158  0.952639 0.021499}
\CommentTok{#> 4 0.000000    0.000657   0.049140  0.092469 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> }
\CommentTok{#> MSE:  319}
\CommentTok{#> RMSE:  17.9}
\CommentTok{#> MAE:  14.2}
\CommentTok{#> RMSLE:  0.558}
\CommentTok{#> Mean Residual Deviance :  319}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 11.54 6.85 6.7 4.46 2.81 ...}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 12.7095700916471}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0804}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0770472630950723}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.80949}
\CommentTok{#> SL.ksvm_All    0.1285 0.00989}
\CommentTok{#> SL.glmnet_All  0.3072 0.00000}
\CommentTok{#> SL.ranger_All  0.0848 0.18062}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> }
\CommentTok{#>                  Risk  Coef}
\CommentTok{#> SL.xgboost_All 0.0603 0.807}
\CommentTok{#> SL.ranger_All  0.0828 0.193}
...
\CommentTok{#>     Discrete SL 0.17 0.015 0.104 0.25}
...
\CommentTok{#> SL.ranger_All  0.163 0.502}
\CommentTok{#> SL.ksvm_All    0.164 0.498}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.7 4.78 4.92 4.89 4.82 ...}
...
\CommentTok{#> Growing trees.. Progress: 86%. Estimated remaining time: 5 seconds.}
\NormalTok{m.BLD_PTF}
\CommentTok{#> Ranger result}
\CommentTok{#> }
\CommentTok{#> Call:}
