...
\CommentTok{#> R 2018-12-26 20:40:24 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 160.042056403301"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x13ae56c0> }
...
\CommentTok{#>     /tmp/RtmpBITOOc/h2o_travis_started_from_r.out}
\CommentTok{#>     /tmp/RtmpBITOOc/h2o_travis_started_from_r.err}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545856882556_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.014215 0.008419}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.138327 0.189337}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001312 0.000885}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.001351   0.099083  0.333655 0.075856}
\CommentTok{#> 3 0.000000   -0.018689   0.071161  0.951146 0.022155}
\CommentTok{#> 4 0.000000   -0.003487   0.044773  0.079333 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.47 10.71 9.03 6.49 3.56 ...}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.48}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.41250854468439}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1530}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0822325731421144}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8132}
\CommentTok{#> SL.ksvm_All    0.1287 0.0138}
\CommentTok{#> SL.glmnet_All  0.3076 0.0000}
\CommentTok{#> SL.ranger_All  0.0848 0.1731}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.0826 0.193}
...
\CommentTok{#> SL.ranger_All  0.165 0.477}
\CommentTok{#> SL.ksvm_All    0.163 0.523}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.67 4.73 4.87 4.84 4.77 ...}
