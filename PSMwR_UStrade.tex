...
\CommentTok{#> R 2018-12-25 17:57:59 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 163.052945149987"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x130ab338> }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545760740355_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.014052 0.007774}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.124011 0.175517}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001346 0.000974}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.001214   0.102623  0.363730 0.062596}
\CommentTok{#> 3 0.000000   -0.017989   0.070715  0.957368 0.018356}
\CommentTok{#> 4 0.000000   -0.002270   0.050475  0.115341 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> MAE:  12.4}
\CommentTok{#> RMSLE:  0.497}
\CommentTok{#> Mean Residual Deviance :  260}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 15.57 9.84 8.57 5.6 3.38 ...}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.36}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.25160676175496}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1486}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0855}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0782029817510056}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.80984}
\CommentTok{#> SL.ksvm_All    0.1288 0.00511}
\CommentTok{#> SL.glmnet_All  0.3077 0.00000}
\CommentTok{#> SL.ranger_All  0.0846 0.18505}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.0841 0.179}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.68 4.75 4.89 4.85 4.79 ...}
