...
\CommentTok{#> R 2018-12-20 19:59:30 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 159.101122846463"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x1408f3d0> }
...
\CommentTok{#>     /tmp/RtmplVNFI4/h2o_travis_started_from_r.out}
\CommentTok{#>     /tmp/RtmplVNFI4/h2o_travis_started_from_r.err}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> Starting H2O JVM and connecting: .. Connection successful!}
\CommentTok{#> }
\CommentTok{#> R is connected to the H2O cluster: }
\CommentTok{#>     H2O cluster uptime:         2 seconds 81 milliseconds }
...
\CommentTok{#> Mean Residual Deviance :  223}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545336028781_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.015081 0.011186}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.145290 0.178534}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001430 0.001774}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.004077   0.104408  0.368161 0.064825}
\CommentTok{#> 3 0.000000   -0.018190   0.070861  0.957299 0.019172}
\CommentTok{#> 4 0.000000   -0.006394   0.049087  0.109075 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.18 10.42 8.3 5.61 3.05 ...}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.19}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.1941902127496}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1499}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0822}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.079490689196994}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.81078}
\CommentTok{#> SL.ksvm_All    0.1292 0.00783}
\CommentTok{#> SL.glmnet_All  0.3081 0.00000}
\CommentTok{#> SL.ranger_All  0.0845 0.18139}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.0832 0.187}
\CommentTok{#> SL.ksvm_All    0.1312 0.000}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.164 0.477}
\CommentTok{#> SL.ksvm_All    0.162 0.523}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.64 4.7 4.84 4.83 4.75 ...}
