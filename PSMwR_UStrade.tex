...
\CommentTok{#> R 2018-12-26 21:14:18 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 161.521948433195"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x13d01648> }
...
\CommentTok{#>     /tmp/Rtmpt8L6lg/h2o_travis_started_from_r.out}
\CommentTok{#>     /tmp/Rtmpt8L6lg/h2o_travis_started_from_r.err}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> Starting H2O JVM and connecting: .. Connection successful!}
\CommentTok{#> }
\CommentTok{#> R is connected to the H2O cluster: }
\CommentTok{#>     H2O cluster uptime:         2 seconds 311 milliseconds }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545858918432_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.015402 0.008998}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.125587 0.176580}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001307 0.000946}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.002108   0.102980  0.364898 0.062272}
\CommentTok{#> 3 0.000000   -0.017996   0.070991  0.956696 0.017641}
\CommentTok{#> 4 0.000000   -0.000888   0.046938  0.114380 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 13.81 10.01 9.14 6.22 3.35 ...}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.28}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.20286354468929}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1303}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0846}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0781862440510234}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.80093}
\CommentTok{#> SL.ksvm_All    0.1292 0.00322}
\CommentTok{#> SL.glmnet_All  0.3079 0.00000}
\CommentTok{#> SL.ranger_All  0.0835 0.19585}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.7 4.78 4.9 4.85 4.79 ...}
