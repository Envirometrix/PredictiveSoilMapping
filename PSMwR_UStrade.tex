...
\CommentTok{#> R 2018-12-26 07:15:55 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 160.23593298676"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x14af82c8> }
...
\CommentTok{#>     /tmp/RtmpWj1eMX/h2o_travis_started_from_r.out}
\CommentTok{#>     /tmp/RtmpWj1eMX/h2o_travis_started_from_r.err}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> Starting H2O JVM and connecting: .. Connection successful!}
\CommentTok{#> }
\CommentTok{#> R is connected to the H2O cluster: }
\CommentTok{#>     H2O cluster uptime:         2 seconds 149 milliseconds }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545808614472_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.014830 0.008067}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.118650 0.177109}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001324 0.001130}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.004273   0.097646  0.334939 0.081471}
\CommentTok{#> 3 0.000000   -0.018366   0.071041  0.953921 0.017316}
\CommentTok{#> 4 0.000000    0.012150   0.049311  0.097014 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> MAE:  12.6}
\CommentTok{#> RMSLE:  0.512}
\CommentTok{#> Mean Residual Deviance :  278}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.94 10.31 8.78 6.41 3.26 ...}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.15121117994767}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1710}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0761}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0747319616597749}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8159}
\CommentTok{#> SL.ksvm_All    0.1288 0.0124}
\CommentTok{#> SL.glmnet_All  0.3081 0.0000}
\CommentTok{#> SL.ranger_All  0.0852 0.1717}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.0831 0.19}
\CommentTok{#> SL.ksvm_All    0.1299 0.00}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.164 0.483}
\CommentTok{#> SL.ksvm_All    0.163 0.517}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.71 4.8 4.93 4.91 4.84 ...}
