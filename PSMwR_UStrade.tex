...
\CommentTok{#> R 2018-12-20 19:14:52 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 161.667638052228"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x138e98e8> }
...
\CommentTok{#>     /tmp/RtmpEJwPj9/h2o_travis_started_from_r.out}
\CommentTok{#>     /tmp/RtmpEJwPj9/h2o_travis_started_from_r.err}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> Starting H2O JVM and connecting: .. Connection successful!}
\CommentTok{#> }
\CommentTok{#> R is connected to the H2O cluster: }
\CommentTok{#>     H2O cluster uptime:         2 seconds 199 milliseconds }
...
\CommentTok{#> RMSE:  15}
\CommentTok{#> MAE:  10.2}
\CommentTok{#> RMSLE:  0.432}
\CommentTok{#> Mean Residual Deviance :  225}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545333351356_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.016600 0.012066}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.130356 0.179884}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001434 0.001023}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.005325   0.098814  0.328539 0.074887}
\CommentTok{#> 3 0.000000   -0.019477   0.071112  0.946791 0.023099}
\CommentTok{#> 4 0.000000    0.006665   0.046579  0.089211 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> }
\CommentTok{#> MSE:  297}
\CommentTok{#> RMSE:  17.2}
\CommentTok{#> MAE:  13.2}
\CommentTok{#> RMSLE:  0.528}
\CommentTok{#> Mean Residual Deviance :  297}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.33 10.31 9.26 6.2 3.08 ...}
...
\CommentTok{#>   ..$ ME          : num -0.103}
\CommentTok{#>   ..$ MAE         : num 2.12}
\CommentTok{#>   ..$ RMSE        : num 3.61}
\CommentTok{#>   ..$ R.squared   : num 0.574}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.53}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.47543626707029}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1687}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0800}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0760619199914062}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8180}
\CommentTok{#> SL.ksvm_All    0.1299 0.0126}
\CommentTok{#> SL.glmnet_All  0.3077 0.0000}
\CommentTok{#> SL.ranger_All  0.0858 0.1695}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.0827 0.192}
...
\CommentTok{#> SL.ranger_All  0.165 0.463}
\CommentTok{#> SL.ksvm_All    0.162 0.537}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.68 4.75 4.9 4.86 4.8 ...}
