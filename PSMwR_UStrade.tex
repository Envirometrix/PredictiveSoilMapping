...
\CommentTok{#> R 2018-12-27 18:22:23 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 162.034944361077"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x1367fa68> }
...
\CommentTok{#>     /tmp/RtmpSS0lFH/h2o_travis_started_from_r.out}
\CommentTok{#>     /tmp/RtmpSS0lFH/h2o_travis_started_from_r.err}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> Starting H2O JVM and connecting: .. Connection successful!}
\CommentTok{#> }
\CommentTok{#> R is connected to the H2O cluster: }
\CommentTok{#>     H2O cluster uptime:         2 seconds 68 milliseconds }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545935002398_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.015663 0.009889}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.134548 0.185694}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001423 0.001167}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.004060   0.104245  0.371845 0.064195}
\CommentTok{#> 3 0.000000   -0.018651   0.071084  0.955262 0.017383}
\CommentTok{#> 4 0.000000    0.000021   0.048753  0.182932 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> }
\CommentTok{#> MSE:  241}
\CommentTok{#> RMSE:  15.5}
\CommentTok{#> MAE:  11.6}
\CommentTok{#> RMSLE:  0.471}
\CommentTok{#> Mean Residual Deviance :  241}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.75 10.31 8.91 6.3 3.08 ...}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.71}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.66711372782736}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1477}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0883}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0848509727492723}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8229}
\CommentTok{#> SL.ksvm_All    0.1282 0.0196}
\CommentTok{#> SL.glmnet_All  0.3073 0.0000}
\CommentTok{#> SL.ranger_All  0.0862 0.1576}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.0839 0.179}
...
\CommentTok{#> SL.ranger_All  0.165 0.497}
\CommentTok{#> SL.ksvm_All    0.165 0.503}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.65 4.71 4.85 4.82 4.75 ...}
