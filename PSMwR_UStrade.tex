...
\CommentTok{#> R 2018-12-26 02:40:13 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 157.62322369703"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x14b261e8> }
...
\CommentTok{#>     /tmp/Rtmpcoxs7M/h2o_travis_started_from_r.out}
\CommentTok{#>     /tmp/Rtmpcoxs7M/h2o_travis_started_from_r.err}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> Starting H2O JVM and connecting: .. Connection successful!}
\CommentTok{#> }
\CommentTok{#> R is connected to the H2O cluster: }
\CommentTok{#>     H2O cluster uptime:         2 seconds 139 milliseconds }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545792073309_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.013677 0.007741}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.154719 0.185816}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001445 0.000943}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000   -0.000400   0.101822  0.363013 0.062308}
\CommentTok{#> 3 0.000000   -0.017796   0.071129  0.955900 0.020008}
\CommentTok{#> 4 0.000000   -0.000015   0.048708  0.103778 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 15.11 11.15 9.47 5.61 2.93 ...}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.76}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.54381124589522}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1412}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0810}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0786131303075795}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.80982}
\CommentTok{#> SL.ksvm_All    0.1296 0.00837}
\CommentTok{#> SL.glmnet_All  0.3076 0.00000}
\CommentTok{#> SL.ranger_All  0.0844 0.18181}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.0824 0.192}
...
\CommentTok{#> SL.ranger_All  0.164 0.486}
\CommentTok{#> SL.ksvm_All    0.163 0.514}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.69 4.77 4.89 4.85 4.78 ...}
