...
\CommentTok{#> R 2018-12-20 19:49:37 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 158.67874398964"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x14a0ab90> }
...
\CommentTok{#>     /tmp/RtmpWwFFdq/h2o_travis_started_from_r.out}
\CommentTok{#>     /tmp/RtmpWwFFdq/h2o_travis_started_from_r.err}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> Starting H2O JVM and connecting: .. Connection successful!}
\CommentTok{#> }
\CommentTok{#> R is connected to the H2O cluster: }
\CommentTok{#>     H2O cluster uptime:         1 seconds 961 milliseconds }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545335434872_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.015954 0.009676}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.159465 0.205304}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001523 0.001328}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.000253   0.100720  0.340378 0.070708}
\CommentTok{#> 3 0.000000   -0.018383   0.070822  0.950857 0.018346}
\CommentTok{#> 4 0.000000    0.003261   0.046110  0.090140 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> }
\CommentTok{#> MSE:  265}
\CommentTok{#> RMSE:  16.3}
\CommentTok{#> MAE:  12.5}
\CommentTok{#> RMSLE:  0.503}
\CommentTok{#> Mean Residual Deviance :  265}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.9 10.17 8.91 5.69 3.5 ...}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.28095834797673}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1327}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0923}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0871124373251532}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.mean_All    0.7540 0.00e+00}
\CommentTok{#> SL.xgboost_All 0.0598 8.01e-01}
\CommentTok{#> SL.ksvm_All    0.1293 7.53e-06}
\CommentTok{#> SL.glmnet_All  0.3086 0.00e+00}
\CommentTok{#> SL.ranger_All  0.0838 1.99e-01}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> }
\CommentTok{#>                  Risk  Coef}
\CommentTok{#> SL.xgboost_All 0.0603 0.811}
\CommentTok{#> SL.ranger_All  0.0830 0.189}
...
\CommentTok{#>   SL.ranger_All 0.16 0.015 0.102 0.25}
...
\CommentTok{#> SL.ranger_All  0.166 0.464}
\CommentTok{#> SL.ksvm_All    0.163 0.536}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.65 4.7 4.84 4.82 4.75 ...}
...
\CommentTok{#> Growing trees.. Progress: 98%. Estimated remaining time: 0 seconds.}
\NormalTok{m.BLD_PTF}
\CommentTok{#> Ranger result}
\CommentTok{#> }
\CommentTok{#> Call:}
