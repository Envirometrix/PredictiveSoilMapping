...
\CommentTok{#> R 2018-12-20 14:43:05 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 160.768115765597"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x145e42a0> }
...
\CommentTok{#>     H2O cluster uptime:         10 minutes 7 seconds }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545316435457_12 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.014699 0.009137}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.123093 0.172407}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001310 0.000849}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.003360   0.100833  0.344009 0.071233}
\CommentTok{#> 3 0.000000   -0.018352   0.070996  0.952509 0.020792}
\CommentTok{#> 4 0.000000    0.003180   0.047642  0.095419 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 12.1 7.8 6.89 4.75 3.07 ...}
...
\CommentTok{#>   ..$ ME          : num -0.151}
\CommentTok{#>   ..$ MAE         : num 2.21}
\CommentTok{#>   ..$ RMSE        : num 3.7}
\CommentTok{#>   ..$ R.squared   : num 0.552}
\CommentTok{#>   ..$ logRMSE     : num 0.502}
\CommentTok{#>   ..$ logR.squared: num 0.626}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 12.5013071389354}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1446}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0809400574849384}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8188}
\CommentTok{#> SL.ksvm_All    0.1286 0.0136}
\CommentTok{#> SL.glmnet_All  0.3072 0.0000}
\CommentTok{#> SL.ranger_All  0.0855 0.1676}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> }
\CommentTok{#>                  Risk Coef}
\CommentTok{#> SL.xgboost_All 0.0603 0.82}
\CommentTok{#> SL.ranger_All  0.0838 0.18}
\CommentTok{#> SL.ksvm_All    0.1306 0.00}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>     Discrete SL 0.17 0.015 0.114 0.25}
\CommentTok{#>  SL.xgboost_All 0.19 0.016 0.135 0.27}
\CommentTok{#>   SL.ranger_All 0.16 0.015 0.103 0.25}
...
\CommentTok{#> SL.ranger_All  0.166 0.472}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.68 4.76 4.89 4.84 4.78 ...}
