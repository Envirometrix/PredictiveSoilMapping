...
\CommentTok{#> R 2018-12-21 10:36:47 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 161.056848542542"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x1395b200> }
...
\CommentTok{#>     /tmp/RtmptBX7cb/h2o_travis_started_from_r.out}
\CommentTok{#>     /tmp/RtmptBX7cb/h2o_travis_started_from_r.err}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> Starting H2O JVM and connecting: .. Connection successful!}
\CommentTok{#> }
\CommentTok{#> R is connected to the H2O cluster: }
\CommentTok{#>     H2O cluster uptime:         2 seconds 161 milliseconds }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545388667203_2 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.015095 0.008726}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.132546 0.167933}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001319 0.000798}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.007270   0.101189  0.346811 0.064626}
\CommentTok{#> 3 0.000000   -0.019031   0.070855  0.951340 0.021552}
\CommentTok{#> 4 0.000000    0.005423   0.048320  0.100043 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 14.18 10.16 8.83 6.2 3.51 ...}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 8.20}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 8.1303469483056}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1423}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.076693646434572}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8144}
\CommentTok{#> SL.ksvm_All    0.1283 0.0125}
\CommentTok{#> SL.glmnet_All  0.3084 0.0000}
\CommentTok{#> SL.ranger_All  0.0850 0.1731}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ranger_All  0.0835 0.184}
\CommentTok{#> SL.ksvm_All    0.1291 0.000}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>     Discrete SL 0.16 0.015 0.105 0.25}
\CommentTok{#>  SL.xgboost_All 0.19 0.016 0.135 0.27}
\CommentTok{#>   SL.ranger_All 0.16 0.015 0.105 0.25}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.65 4.72 4.86 4.82 4.77 ...}
