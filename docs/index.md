...
[Bob MacMillan](https://opengeohub.org/people/bob-macmillan) is the Chair of OpenGeoHub Foundation, Board member AfSIS Ltd, and Principal of the LandMapper Environmental Solutions Inc. Bob began as a soil surveyor at the Alberta Research Council (Canada) in 1976, and led the Soil Inventory Section from 1984–1987 when he left to pursue a Ph.D. At ARC Bob was responsible for introducing the use of GIS, DB management systems, geostatistics and automated analysis of DEMs for soil surveys in Alberta. Working in Tanzania from 1982–84 on secondment to CIDA, Bob produced soil surveys, developed and implemented farm scale conservation plans for 60,000 ha of wheat farms and carried out grid soil surveys for research farm plots. Bob conceived of, wrote and applied a set of programs (LandMapR) for applying fuzzy logic to elevation and other data to automatically classify and map landforms, ecosites, soil units and hydrological spatial entities (streams and ponds). Bob personally applied these programs to over 10 million ha of landscapes in Canada, and assisted others to apply them to millions more in Canada, the UK, Brazil, USA, Germany, Australia, Indonesia and Ireland. Many individuals practicing automated mapping in Canada were introduced to the discipline through Bob, via the LandMapR programs. As Science Coordinator for the GlobalSoilMap project, Bob helped to articulate the vision for the project and led initial activities aimed at achieving this, including authoring technical specifications, promoting the project, recruiting participants/cooperators, and liaising with representatives of national and international soil agencies.
