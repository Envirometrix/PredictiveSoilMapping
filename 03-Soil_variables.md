...
<div class="figure" style="text-align: center">
<img src="psm_files/figure-epub3/plot-tt-triangle-1.png" alt="Soil texture triangle based on the USDA system. Generated using the soiltexture package (http://cran.r-project.org/web/packages/soiltexture/)." width="70%" />
...
<div class="figure" style="text-align: center">
<img src="psm_files/figure-epub3/plot-tt-afsis-1.png" alt="Distribution of observed soil textures for the Africa Soil Profiles (http://gsif.r-forge.r-project.org/afsp.html)." width="70%" />
...
<div class="figure" style="text-align: center">
<img src="psm_files/figure-epub3/plot-af-soil-cols-1.png" alt="Actual observed soil colors (moist) for the top soil based on the Africa Soil Profiles Database (http://gsif.r-forge.r-project.org/afsp.html)." width="100%" />
