...
\CommentTok{#> R 2018-12-20 13:42:24 interpolating 155 observations, 3103 prediction locations}
...
\CommentTok{#> [1] "estimated time for  copula 158.930546614488"}
...
\CommentTok{#>   .. ..- attr(*, ".Environment")=<environment: 0x14c0d038> }
...
\CommentTok{#>     H2O cluster uptime:         11 minutes 22 seconds }
...
\CommentTok{#> Model ID:  DeepLearning_model_R_1545312721386_12 }
...
\CommentTok{#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.013980 0.009655}
\CommentTok{#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.122292 0.177079}
\CommentTok{#> 4     4     1    Linear      NA 0.000000 0.000000  0.001346 0.001507}
\CommentTok{#>   momentum mean_weight weight_rms mean_bias bias_rms}
\CommentTok{#> 1       NA          NA         NA        NA       NA}
\CommentTok{#> 2 0.000000    0.006723   0.101916  0.359228 0.063977}
\CommentTok{#> 3 0.000000   -0.018401   0.071196  0.955391 0.020177}
\CommentTok{#> 4 0.000000   -0.004954   0.050676  0.096368 0.000000}
\CommentTok{#> }
\CommentTok{#> }
...
\CommentTok{#> }
\CommentTok{#> MSE:  329}
\CommentTok{#> RMSE:  18.1}
\CommentTok{#> MAE:  14.6}
\CommentTok{#> RMSLE:  0.568}
\CommentTok{#> Mean Residual Deviance :  329}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   ..$ Predicted: num [1:4972] 12.11 7.25 6.96 5.13 2.99 ...}
...
\CommentTok{#>   ..$ RMSE        : num 3.68}
\CommentTok{#>   ..$ R.squared   : num 0.557}
\CommentTok{#>   ..$ logRMSE     : num 0.495}
\CommentTok{#>   ..$ logR.squared: num 0.634}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1 h2o.randomForest.wrapper 13.2}
...
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 12.5760603784064}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 4 h2o.deeplearning.wrapper 0.1548}
\CommentTok{#> 3          h2o.gbm.wrapper 0.0971}
\CommentTok{#> 2 h2o.randomForest.wrapper 0.0821}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> H2O Ensemble Performance on <newdata>:}
\CommentTok{#> ----------------}
\CommentTok{#> Family: gaussian}
\CommentTok{#> }
\CommentTok{#> Ensemble performance (MSE): 0.0783755363638977}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.xgboost_All 0.0598 0.8276}
\CommentTok{#> SL.ksvm_All    0.1286 0.0248}
\CommentTok{#> SL.glmnet_All  0.3079 0.0000}
\CommentTok{#> SL.ranger_All  0.0862 0.1476}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> SL.ksvm_All    0.1308 0.000}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>     Discrete SL 0.16 0.014 0.103 0.25}
...
\CommentTok{#> SL.ranger_All  0.164 0.48}
\CommentTok{#> SL.ksvm_All    0.162 0.52}
...
\CommentTok{#> List of 2}
\CommentTok{#>  $ pred           : num [1:3865, 1] 4.66 4.72 4.85 4.82 4.75 ...}
...
\CommentTok{#> Growing trees.. Progress: 58%. Estimated remaining time: 22 seconds.}
\NormalTok{m.BLD_PTF}
\CommentTok{#> Ranger result}
\CommentTok{#> }
\CommentTok{#> Call:}
