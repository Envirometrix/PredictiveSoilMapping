...
and computing costs per update can be significant (see further).
...
similar. For PSM project type III spatio-temporal prediction models can
...
![](media/image3.png){width="4.230323709536308in"
height="5.046875546806649in"}

Image 1: Types of PSM projects depending on whether maps are generated
for single usage, or for detecting change or soil monitoring.
...
![](media/image4.png){width="6.313385826771653in"
height="3.6180555555555554in"}

Image 2: General Soil Information System scheme.
...
> ![](media/image2.png){width="6.4375in" height="1.5520833333333333in"}\
> Image 3: Example of a soil mask scheme.
...
size and number of rows and columns:
  ...
  -------------------------------------------------------------------------
                    ...
                    Maximum northing                      
  ----------------- ------------------------------------- -----------------
  Xmin\             Spatial resolution in m (projected)   Xmax
  Minimum easting                                         
                    Spatial resolution in DD              Maximum easting
...
An alternative to using OVH is the Amazon AWS. Amazon AWS server, with a
similar configuration, might appear to cost much more than an OVH server
...
Amazon AWS, if used continuously 100% for the whole month, would cost
about 2.5 times more than OVH server. The recommended server for running
PSM on Amazon AWS is:
...
### Technical specifications PSM project (order forms)

General specifications of the study area:
...
G.6 Grid definition:
 ...
 - Xmax:
 - Ymax:
G.7 Target projection system ([*proj4*](https://proj4.org/) code):
G.8 Total area:
 - in square-km
G.9 Inspection density:
 - Detailed soil profiles: (observations per square-km)
 - Soil semi-profiles:
...
G.14 Target [*user groups*](https://envirometrix.github.io/PredictiveSoilMapping/introduction.html#soil-information-users) and workflows (targeted services):
...
Table 2: List of suggested and recommended target soil variables (3D
mapping). Codes based on the "National Soil Carbon Network Templates".
Complete list of variables available
[*here*](https://docs.google.com/spreadsheets/d/1ZmFa2R9mfiMxoOOP_ISAF6Ca5QMFJYL54pV-b_4zHTU/edit#gid=468368665).
Note: complete list can be even longer, up to 200+ soil variables can be
mapped using PSM.

  Soil variable   Unit         Lower   Mean   Upper   0   5   15   30   60   100   200
  --------------- ------------ ------- ------ ------- --- --- ---- ---- ---- ----- -----
  carbonates      %wt          ❑       ❑      ❑       ❑   ❑   ❑    ❑    ❑    ❑     ❑
  cn\_ratio                    ❑       ❑      ❑       ❑   ❑   ❑    ❑    ❑    ❑     ❑
  n\_tot          %wt          ❑       ❑      ❑       ❑   ❑   ❑    ❑    ❑    ❑     ❑
...
Table 3: List of suggested and recommended target soil variables (2D
mapping).

  Soil variable     Unit    Lower   Mean   Upper
  ----------------- ------- ------- ------ -------
  soc\_stock        kg/m3   ❑       ❑      ❑
  bedrock\_depth    cm      ❑       ❑      ❑
  depth\_water      cm      ❑       ❑      ❑
...
Table 4: List of recommended covariates of interest (publicly available
covariates listed only). Complete list available
[*here*](https://envirometrix.github.io/PredictiveSoilMapping/soil-covs-chapter.html#soil-covariate-data-sources).

  Covariate                                                                                                                                         Source                                                                                                                                                                              Type   2km   1km   250   100   30
  ------------------------------------------------------------------------------------------------------------------------------------------------- ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- ------ ----- ----- ----- ----- ----
  ALOS AW3D30 surface elevation                                                                                                                     [*http://www.eorc.jaxa.jp/ALOS/en/aw3d30/index.htm*](http://www.eorc.jaxa.jp/ALOS/en/aw3d30/index.htm)                                                                              DEM    ❑     ❑     ❑     ❑     ☑
  MERIT DEM                                                                                                                                         [*http://hydro.iis.u-tokyo.ac.jp/\~yamadai/MERIT\_DEM/*](http://hydro.iis.u-tokyo.ac.jp/~yamadai/MERIT_DEM/)                                                                        DEM    ❑     ❑     ❑     ☑     
  DEM derived parameters (slope, upslope, downslope area, openess, TWI, MVRBF)                                                                      LandGIS                                                                                                                                                                             DEM    ❑     ❑     ❑     ☑     ❑
  WorldClim v2, CHELSA climate and Global Precipitation Measurement Integrated Multi-satellitE Retrievals for GPM (IMERG) rainfall monthly images   LandGIS                                                                                                                                                                             CLIM   ❑     ☑     ❑     ❑     
  MODIS MOD11A2 Land Surface Temperature                                                                                                            LandGIS                                                                                                                                                                             CLIM   ❑     ☑     ❑     ❑     
  MODIS MOD09A1 surface reflectance                                                                                                                 LandGIS                                                                                                                                                                             SURF   ❑     ❑     ☑     ❑     
  MODIS MOD13Q1 EVI monthly                                                                                                                         LandGIS                                                                                                                                                                             VEG    ❑     ❑     ☑     ❑     
  Cloud Fraction based on MODIS MOD09 monthly images                                                                                                [*http://www.earthenv.org/cloud*](http://www.earthenv.org/cloud)                                                                                                                    CLIM   ❑     ☑     ❑     ❑     
  Copernicus Land products Fraction of Absorbed Photosynthetically Active Radiation (FAPAR)                                                         [*https://land.copernicus.eu/global/products/fapar*](https://land.copernicus.eu/global/products/fapar)                                                                              VEG    ❑     ❑     ☑     ❑     
  Bioclimatic variables based on CHELSA climate                                                                                                     [*http://chelsa-climate.org/downloads/*](http://chelsa-climate.org/downloads/)                                                                                                      CLIM   ❑     ☑     ❑     ❑     
  Snow probability based on MODIS snow product                                                                                                      [*http://www.esa-landcover-cci.org/*](http://www.esa-landcover-cci.org/)                                                                                                            CLIM   ❑     ☑     ❑     ❑     
  Land cover based on ESA CCI product                                                                                                               [*http://www.esa-landcover-cci.org/*](http://www.esa-landcover-cci.org/)                                                                                                            LCOV   ❑     ❑     ☑     ❑     
  Lithological class based on the USGS EcoTapestry                                                                                                  [*http://gec.cr.usgs.gov/*](http://gec.cr.usgs.gov/)                                                                                                                                GEOL   ❑     ❑     ☑     ❑     
  Landform class based on the USGS EcoTapestry                                                                                                      [*http://gec.cr.usgs.gov/*](http://gec.cr.usgs.gov/)                                                                                                                                GEOL   ❑     ❑     ☑     ❑     
  Water Vapor based on NEO                                                                                                                          [*http://neo.sci.gsfc.nasa.gov*](http://neo.sci.gsfc.nasa.gov)                                                                                                                      CLIM   ❑     ☑     ❑           
  Global Surface Water occurrence probability                                                                                                       [*https://global-surface-water.appspot.com/download*](https://global-surface-water.appspot.com/download)                                                                            HYDR   ❑     ❑     ❑     ❑     ☑
  PALSAR/PALSAR-2 radar images bands HH and HV                                                                                                      [*http://www.eorc.jaxa.jp/ALOS/en/palsar\_fnf/data/index.htm*](http://www.eorc.jaxa.jp/ALOS/en/palsar_fnf/data/index.htm)                                                           SURF   ❑     ❑     ❑     ❑     ☑
  Global 30m Bare Ground (circa 2010)                                                                                                               [*https://landcover.usgs.gov/glc/*](https://landcover.usgs.gov/glc/)                                                                                                                LCOV   ❑     ❑     ❑     ❑     ☑
  GlobalForestChange project landsat bands NIR SWIR for 2000 and 2014                                                                               [*https://earthenginepartners.appspot.com/science-2013-global-forest/download\_v1.2.html*](https://earthenginepartners.appspot.com/science-2013-global-forest/download_v1.2.html)   SURF   ❑     ❑     ❑     ❑     ☑
  Global Land Cover (GLC) maps based on the GLC30 project                                                                                           [*http://www.globallandcover.com/*](http://www.globallandcover.com/)                                                                                                                LCOV   ❑     ❑     ❑     ❑     ☑

### Spatial prediction methods

Table 5: Statistical and machine learning approaches of interest (see
e.g. Kuhn and Johnson, 2013 and [*Nussbaum et al,
2017*](https://www.soil-journal.net/4/1/2018/soil-4-1-2018.pdf)) and
connected R packages.

  Method                      Package        Type                          Prediction   Comparison   Production
  --------------------------- -------------- ----------------------------- ------------ ------------ ------------
  Random forest               ranger         regression / classification   ❑            ❑            ❑
  SVM                         kernlab        regression / classification   ❑            ❑            ❑
  Cubist                      cubist         regression / classification   ❑            ❑            ❑
  XGBoost                     xgboost        regression                    ❑            ❑            ❑
  Gradient Boosting Machine   gbm            regression                    ❑            ❑            ❑
  Extreme Learning Machine    elmNNRcpp      regression / classification   ❑            ❑            ❑
  Deep learning               h2o            regression / classification   ❑            ❑            ❑
  GeoGAM                      geoGAM         regression                    ❑            ❑            ❑
  Kriging                     geoR / gstat   regression                    ❑            ❑            ❑

### Delivery and hosting of maps

Table 6: Possibilities for hosting the produced data.

  ----------------------------------------------------------------------------------------------------------
  Layers                                         Size category   FTP   WMS   WCS   REST API   SDT   Inter.
  ...
  Primary predictions of soil variables          \*\*\*\*        ❑     ❑     ❑     ❑          ❑     ❑

  Secondary soil variables                       \*\*\*          ❑     ❑     ❑     ❑          ❑     ❑

  Uncertainty maps (lower and upper intervals)   \*\*\*\*\*      ❑     ❑     ❑     ❑          ❑     ❑

  Decision ready maps                            \*\*\*          ❑     ❑     ❑     ❑          ❑     ❑
  ----------------------------------------------------------------------------------------------------------

\*SDT = Scalable download traffic
...
-   Data production costs expressed per M pixels of data,

-   Data maintenance and web-serving costs, usually expressed as
    monthly/yearly costs,

Table 7: Standard soil data production costs (approximate estimates) per
soil data quality category (see below). L0 = initial product with only
few soil properties, no quality/accuracy requirements, L1 = final
complete product with no quality/accuracy requirements, L2 = final
complete product matching standard accuracy requirements, L3 = final
complete certified product according to the ISO or similar standards.
For more info see also Hengl et al. (2014).

  *Type of PSM project*                                                        Output data quality level
  ---------------------------------------------------------------------------- --------------------------- ----------------------- -------------------------- ------------------------
                                                                               L0
  PSM projects in new area (single state)                                      &gt;500 US\$ / Mpix
  PSM projects using legacy points (single state)                              0.8 US\$ / Mpix
  PSM projects aiming at optimizing predictions and usability (single state)   0.5 US\$ / Mpix
  PSM change detection project (two states)                                    NA
  PSM monitoring projects (multiple states)                                    NA
