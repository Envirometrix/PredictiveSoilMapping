...
```{r psm-types-monitoring, echo=FALSE, fig.cap="Types of PSM projects depending on whether maps are generated for single usage, or for detecting change or soil monitoring.", out.width="75%"}
...
```{r soil-mask-scheme, echo=FALSE, fig.cap="Example of a soil mask scheme.", out.width="100%"}
...
```{r aws-htop-server, echo=FALSE, fig.cap="Example of an AWS dedicated server running spatial predictions on 96 threads and using almost 500GB or RAM. Renting out this server can costs up to 8 USD per hour.", out.width="100%"}
...
knitr::kable(
  ...
  caption = 'Example of a costs table for various quality levels PSM products. Prices expressed per M (million) of pixels produced.'
)
```
